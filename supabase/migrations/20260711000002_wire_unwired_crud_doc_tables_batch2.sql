-- Doc-jsonb tables for the previously-unwired CRUD pages (batch 2).
...
BEGIN
  FOREACH t IN ARRAY ARRAY[
    'aibomregistry_table','redteamfindings_table','supplychainattestations_table',
    'postmarket_table','marketplace_table','modellifecycle_table'
  ]
  LOOP
