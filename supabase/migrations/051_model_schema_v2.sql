...
-- Replay-safety guard: the legacy models table is not part of the repo schema (superseded by ai_models)
-- On the live database this migration already ran when models existed, so the
-- guard is a no-op there. On a from-zero replay models does not exist yet at
