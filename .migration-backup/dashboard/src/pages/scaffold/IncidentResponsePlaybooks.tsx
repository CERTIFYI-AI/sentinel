...
//
// WS2 — IR Playbooks (scaffolded page).
// Category: Incidents
//
...
export default function IncidentResponsePlaybooks() {
  ...
  return (
    <ModuleScaffold
      title="IR Playbooks"
      subtitle="Executable incident response playbooks and ownership."
      icon={Siren}
      breadcrumb={[{ label: "Incidents" }, { label: "IR Playbooks" }]}
    ...
    >
      <section aria-label="IR Playbooks records">
