...
//
// WS2 — Prompt Library (scaffolded page).
// Category: AI
//
...
export default function AiPromptLibrary() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Versioned prompts, evaluations, and approved use cases."
      icon={ChatText}
      breadcrumb={[{ label: "AI" }, { label: "Prompt Library" }]}
    ...
    >
      <section aria-label="Prompt Library records">
