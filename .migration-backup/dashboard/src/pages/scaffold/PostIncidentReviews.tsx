...
//
// WS2 — Post-Incident Reviews (scaffolded page).
// Category: Incidents
//
...
export default function PostIncidentReviews() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Blameless post-mortems and corrective actions."
      icon={Notebook}
      breadcrumb={[{ label: "Incidents" }, { label: "Post-Incident Reviews" }]}
    ...
    >
      <section aria-label="Post-Incident Reviews records">
