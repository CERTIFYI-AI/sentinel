...
//
// WS2 — Committee Calendar (scaffolded page).
// Category: Governance
//
...
export default function CommitteeCalendar() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Upcoming audit, risk, and compliance committee meetings."
      icon={Calendar}
      breadcrumb={[{ label: "Governance" }, { label: "Committee Calendar" }]}
    ...
    >
      <section aria-label="Committee Calendar records">
