...
//
// WS2 — Data Lineage (scaffolded page).
// Category: Data
//
...
export default function DataLineage() {
  ...
  return (
    <ModuleScaffold
      title="Data Lineage"
      subtitle="Upstream-downstream lineage for datasets and pipelines."
      icon={TreeStructure}
      breadcrumb={[{ label: "Data" }, { label: "Data Lineage" }]}
    ...
    >
      <section aria-label="Data Lineage records">
