...
//
// WS2 — Awareness Campaigns (scaffolded page).
// Category: Training
//
...
export default function AwarenessCampaigns() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Phishing, security, and privacy awareness campaigns."
      icon={Megaphone}
      breadcrumb={[{ label: "Training" }, { label: "Awareness Campaigns" }]}
    ...
    >
      <section aria-label="Awareness Campaigns records">
