...
//
// WS2 — Vendor Contract Review (scaffolded page).
// Category: Vendors
//
...
export default function VendorContractReview() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="DPA, SLA, and subprocessor clauses tracked per vendor."
      icon={FileText}
      breadcrumb={[{ label: "Vendors" }, { label: "Vendor Contract Review" }]}
    ...
    >
      <section aria-label="Vendor Contract Review records">
