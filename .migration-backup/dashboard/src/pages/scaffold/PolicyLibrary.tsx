...
//
// WS2 — Policy Library (scaffolded page).
// Category: Governance
//
...
export default function PolicyLibrary() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Published policies, versions, and attestation status."
      icon={BookOpen}
      breadcrumb={[{ label: "Governance" }, { label: "Policy Library" }]}
    ...
    >
      <section aria-label="Policy Library records">
