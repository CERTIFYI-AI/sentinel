...
//
// WS2 — Data Quality Metrics (scaffolded page).
// Category: Data
//
...
export default function DataQualityMetrics() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Freshness, completeness, and validity trends per domain."
      icon={ChartLineUp}
      breadcrumb={[{ label: "Data" }, { label: "Data Quality Metrics" }]}
    ...
    >
      <section aria-label="Data Quality Metrics records">
