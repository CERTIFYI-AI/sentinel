...
//
// WS2 — DPIA Builder (scaffolded page).
// Category: Privacy
//
...
export default function PrivacyDpiaBuilder() {
  ...
  return (
    <ModuleScaffold
      title="DPIA Builder"
      subtitle="Data-protection impact assessments per processing activity."
      icon={ShieldChevron}
      breadcrumb={[{ label: "Privacy" }, { label: "DPIA Builder" }]}
    ...
    >
      <section aria-label="DPIA Builder records">
