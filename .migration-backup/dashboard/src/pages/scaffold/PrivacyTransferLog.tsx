...
//
// WS2 — Cross-Border Transfers (scaffolded page).
// Category: Privacy
//
...
export default function PrivacyTransferLog() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="SCC/IDTA agreements and transfer impact assessments."
      icon={Globe}
      breadcrumb={[{ label: "Privacy" }, { label: "Cross-Border Transfers" }]}
    ...
    >
      <section aria-label="Cross-Border Transfers records">
