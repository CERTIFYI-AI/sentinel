...
// demo tables: GDPR Art. 30 RoPA and Chapter V transfer impact assessments.
// Mutations invalidate; errors surface from the services.
// (The control-library hook that used to live here was dead code over the
// superseded complianceControlsService — the canonical hook is
// hooks/queries/useControls over controlService.)
