  ...
  return (
    <div className="p-6 max-w-7xl mx-auto" style={{ fontFamily: 'Inter, Outfit, system-ui, sans-serif' }}>
      ...
      <div className="bg-white rounded-xl border shadow-sm"><table className="w-full text-sm">
        <thead className="bg-gray-50"><tr><th className="p-3 text-left">Test</th><th className="p-3 text-left">Model A</th><th className="p-3 text-left">Model B</th><th className="p-3 text-left">Winner</th><th className="p-3 text-left">Metric</th><th className="p-3 text-left">Date</th></tr></thead>
