    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-1">Security and compliance controls</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-zinc-800/50">
              <tr>
              <th className="px-4 py-3 text-left text-xs font-medium text-zinc-400 uppercase tracking-wider">Control ID</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-zinc-400 uppercase tracking-wider">Control Name</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-zinc-400 uppercase tracking-wider">Framework</th>
            ...
            <tbody className="divide-y divide-zinc-800">
              ...
              <td className="px-4 py-3 text-sm text-zinc-300">{item.control_id}</td>
              <td className="px-4 py-3 text-sm text-zinc-300">{item.name}</td>
              <td className="px-4 py-3 text-sm text-zinc-300"><span className={"px-2 py-1 text-xs rounded-full " + ({"ISO 27001": "bg-red-900/50 text-red-400", "SOC-2": "bg-orange-900/50 text-orange-400", "NIST AI RMF": "bg-yellow-900/50 text-yellow-400", "EU AI Act": "bg-green-900/50 text-green-400", "ISO 42001": "bg-blue-900/50 text-blue-400"}[item.framework] || "bg-zinc-700 text-zinc-300")}>{item.framework}</span></td>
              <td className="px-4 py-3 text-sm text-zinc-300"><span className={"px-2 py-1 text-xs rounded-full " + ({"Technical": "bg-red-900/50 text-red-400", "Administrative": "bg-orange-900/50 text-orange-400", "Physical": "bg-yellow-900/50 text-yellow-400"}[item.category] || "bg-zinc-700 text-zinc-300")}>{item.category}</span></td>
              <td className="px-4 py-3 text-sm text-zinc-300"><span className={"px-2 py-1 text-xs rounded-full " + ({"Implemented": "bg-red-900/50 text-red-400", "Partial": "bg-orange-900/50 text-orange-400", "Planned": "bg-yellow-900/50 text-yellow-400", "Not Applicable": "bg-green-900/50 text-green-400"}[item.status] || "bg-zinc-700 text-zinc-300")}>{item.status}</span></td>
