  ...
  return (
    <div className="p-6 max-w-7xl mx-auto" style={{ fontFamily: 'Inter, Outfit, system-ui, sans-serif' }}>
      ...
      <div className="bg-white rounded-xl border shadow-sm"><table className="w-full text-sm">
        <thead className="bg-gray-50"><tr><th className="p-3 text-left">Framework</th><th className="p-3 text-left">Total Controls</th><th className="p-3 text-left">Implemented</th><th className="p-3 text-left">In Progress</th><th className="p-3 text-left">Score</th><th className="p-3 text-left">Status</th></tr></thead>
