          ...
          {activeTab === "api-keys" && (
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <button className="flex items-center gap-2 px-4 py-2 rounded-lg border border-dashed border-border text-sm text-muted-foreground hover:border-green-500 hover:text-green-400 transition-colors">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 rounded-lg border border-border">
                    ...
                    <p className="text-2xl font-bold">14,820</p>
                  </div>
                  <div className="p-4 rounded-lg border border-border">
