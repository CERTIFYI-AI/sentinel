  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">RegRadar</h1>
        <Button onClick={fetchItems}>Refresh</Button>
      </div>
      <p className="text-muted-foreground">Regulatory intelligence radar tracking compliance changes.</p>
      ...
      <Card>
        <CardHeader><CardTitle>RegRadar Records</CardTitle></CardHeader>
        <CardContent>
