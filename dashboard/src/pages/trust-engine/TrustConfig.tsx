  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Trust Configuration</h1>
          <p className="text-sm text-gray-500 mt-1">Per-model trust configuration: intent boundaries, schemas, fallback chains</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-sm text-gray-500 mt-2">Create your first trust configuration to get started</p>
        </div>
      ) : (
