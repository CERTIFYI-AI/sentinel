  ...
  return (
    <div className="p-6 max-w-7xl mx-auto" style={{ fontFamily: 'Outfit, Inter, system-ui, sans-serif' }}>
      ...
      <div className="bg-white rounded-xl border shadow-sm"><table className="w-full text-sm text-gray-900">
        <thead className="bg-gray-50 text-gray-600"><tr><th className="p-3 text-left">Framework</th><th className="p-3 text-left">Requirement</th><th className="p-3 text-left">Current State</th><th className="p-3 text-left">Target State</th><th className="p-3 text-left">Gap</th><th className="p-3 text-left">Priority</th></tr></thead>
