  ...
  return (
    <div className="p-6 max-w-7xl mx-auto" style={{ fontFamily: 'Inter, Outfit, system-ui, sans-serif' }}>
      ...
      <div className="bg-white rounded-xl border shadow-sm"><table className="w-full text-sm">
        <thead className="bg-gray-50"><tr><th className="p-3 text-left">Benchmark</th><th className="p-3 text-left">Models</th><th className="p-3 text-left">Avg Score</th><th className="p-3 text-left">Best Model</th><th className="p-3 text-left">Last Run</th><th className="p-3 text-left">Status</th></tr></thead>
