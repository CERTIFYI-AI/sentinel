  ...
  return(
    <div className="p-6 bg-slate-50 dark:bg-slate-950 min-h-screen">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div><h1 className="text-2xl font-bold text-slate-900 dark:text-white">Benchmarks</h1>
          <p className="text-slate-500 dark:text-slate-400 text-sm">Model benchmarking</p></div>
      </div>
