        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-surface border border-[hsl(var(--border))] w-full max-w-2xl mx-4 shadow-2xl max-h-[90vh] flex flex-col">
                ...
                <div className="col-span-3">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div>
                      ...
                      <input value={form.model} onChange={e => setForm(p => ({ ...p, model: e.target.value }))} className="w-full px-3 py-2 text-sm border border-[hsl(var(--border))] bg-raised text-[hsl(var(--text-1))] focus:outline-none focus:border-[hsl(var(--brand))]" placeholder="e.g. Credit Scoring Model" />
                    </div>
                    <div>
            ...
            <div className="flex justify-end gap-2 px-5 py-4 border-t border-[hsl(var(--border))]">
              ...
              <button onClick={handleCreate} className="px-4 py-2 text-sm font-medium bg-[hsl(var(--brand))] text-[hsl(var(--bg-surface))] hover:opacity-90">Save Benchmark Run</button>
            </div>
          </div>
        </div>
      )}
