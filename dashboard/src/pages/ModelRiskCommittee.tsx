  ...
  return (
    <TooltipProvider>
      <div className="space-y-6">
        ...
        {/* Quorum Progress Bar */}
        <div className="p-5 bg-[hsl(var(--surface-1))] border border-[hsl(var(--border))] rounded-none">
          ...
          <div className="flex flex-wrap gap-3">
            {MRC_MEMBERS.map(member => (
              <div key={member.id} className={`flex items-center gap-2 px-3 py-2 border rounded-none ${member.quorum ? 'bg-[hsl(var(--brand-subtle))] border-[hsl(var(--brand)/30)]' : 'bg-[hsl(var(--surface-2))] border-[hsl(var(--border))] opacity-60'}`}>
        ...
        <Tabs value={tab} onValueChange={setTab}>
          ...
          <TabsContent value="agenda" className="mt-4 space-y-4">
            {AGENDA_ITEMS.map(item => {
              ...
              return (
                <Card key={item.id} className={`rounded-none border bg-[hsl(var(--surface-1))] ${item.status === 'pending' ? 'border-[hsl(var(--brand))/30]' : 'border-[hsl(var(--border))]'}`}>
                  <CardContent className="p-5">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <Badge className="border-0 rounded-none uppercase text-[10px] bg-[hsl(var(--surface-3))] text-[hsl(var(--text-2))]">{item.type}</Badge>
                        </div>
                    ...
                    {total > 0 && (
                      <div className="mb-4">
                        ...
                        <div className="h-2 w-full flex overflow-hidden bg-[hsl(var(--surface-3))]">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {item.votes.map(v => {
                        ...
                        return (
                          <div key={v.memberId} className="flex items-center gap-2 px-2.5 py-1.5 text-xs border border-[hsl(var(--border))] bg-[hsl(var(--surface-2))]">
          ...
          <TabsContent value="history" className="mt-4">
            <Card className="rounded-none border-[hsl(var(--border))] bg-[hsl(var(--surface-1))] overflow-hidden">
                ...
                <table className="w-full text-sm text-left">
                  ...
                  <tbody>
                    {MEETING_HISTORY.map((m, i) => (
                      <tr key={i} className="border-b border-[hsl(var(--border))] hover:bg-[hsl(var(--surface-2))] cursor-pointer transition-colors"
                        ...
                        <td className="px-4 py-3">
                          <Badge className={`border-0 rounded-none uppercase text-[10px] ${m.type === 'Emergency' ? 'bg-red-500/10 text-red-500' : 'bg-[hsl(var(--surface-3))] text-[hsl(var(--text-2))]'}`}>{m.type}</Badge>
                        </td>
          ...
          <TabsContent value="committee" className="mt-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {MRC_MEMBERS.map(m => (
                <div key={m.id} className={`p-5 flex items-start gap-4 border rounded-none ${m.chair ? 'bg-[hsl(var(--brand-subtle))] border-[hsl(var(--brand)/40)]' : 'bg-[hsl(var(--surface-1))] border-[hsl(var(--border))]'}`}>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-3">
                      ...
                      <Badge className={`border-0 rounded-none uppercase text-[9px] ${m.quorum ? 'bg-emerald-500/10 text-emerald-500' : 'bg-[hsl(var(--surface-3))] text-[hsl(var(--text-3))]'}`}>
            ...
            <div className="mt-4 p-4 text-sm border border-[hsl(var(--border))] bg-[hsl(var(--surface-2))] rounded-none">
          ...
          <TabsContent value="analytics" className="mt-4">
            <div className="grid grid-cols-2 gap-4">
              <Card className="rounded-none bg-[hsl(var(--surface-1))] border-[hsl(var(--border))]">
                <CardContent className="p-5">
      ...
      <Dialog open={!!voteDialog} onOpenChange={() => setVoteDialog(null)}>
        <DialogContent className="max-w-[600px] bg-[hsl(var(--surface-1))] border-[hsl(var(--border))] rounded-none shadow-2xl">
          ...
          <div className="space-y-5 py-4">
            <div className="p-4 text-sm bg-[hsl(var(--surface-2))] border border-[hsl(var(--border))] rounded-none">
                ...
                <button key={v} onClick={() => setVote(v)}
                  className={`p-3 text-sm font-semibold uppercase tracking-wide text-center border-2 rounded-none transition-all ${
                    vote === v
                      ...
                      : 'border-[hsl(var(--border))] bg-[hsl(var(--surface-2))] text-[hsl(var(--text-3))] hover:border-[hsl(var(--text-4))]'
                  }`}>
            ...
            {vote === 'approve' && (
              <div className="space-y-2">
                ...
                <Textarea placeholder="Add any approval conditions…" value={condition} onChange={e => setCondition(e.target.value)} className="text-sm bg-[hsl(var(--surface-2))] border-[hsl(var(--border))] text-[hsl(var(--text-1))] rounded-none focus-visible:ring-[hsl(var(--brand))] min-h-[60px]" />
              </div>
            )}
            <div className="space-y-2">
              ...
              <Textarea placeholder="Your documented rationale for this vote (required for audit trail)…" value={rationale} onChange={e => setRationale(e.target.value)} className="text-sm bg-[hsl(var(--surface-2))] border-[hsl(var(--border))] text-[hsl(var(--text-1))] rounded-none focus-visible:ring-[hsl(var(--brand))] min-h-[80px]" />
            </div>
          </div>
          <DialogFooter className="border-t border-[hsl(var(--border))] pt-5">
            <Button variant="outline" className="rounded-none border-[hsl(var(--border))] text-[hsl(var(--text-2))] hover:text-[hsl(var(--text-1))] hover:bg-[hsl(var(--surface-2))]" onClick={() => setVoteDialog(null)}>Cancel</Button>
      ...
      <Dialog open={scheduleOpen} onOpenChange={setScheduleOpen}>
        <DialogContent className="rounded-none max-w-[600px] bg-[hsl(var(--surface-1))] border-[hsl(var(--border))] shadow-2xl">
          <DialogHeader className="border-b border-[hsl(var(--border))] pb-4">
          ...
          <div className="space-y-5 py-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="date" value={mtgDate} onChange={e => setMtgDate(e.target.value)} className="w-full h-10 rounded-none border border-[hsl(var(--border))] bg-[hsl(var(--surface-2))] px-3 text-sm focus:outline-none focus:ring-1 focus:ring-[hsl(var(--brand))] text-[hsl(var(--text-1))]" />
              </div>
              <div>
                <label className="text-xs font-semibold mb-1 block uppercase tracking-wide text-[hsl(var(--text-2))]">Time</label>
                <input type="time" value={mtgTime} onChange={e => setMtgTime(e.target.value)} className="w-full h-10 rounded-none border border-[hsl(var(--border))] bg-[hsl(var(--surface-2))] px-3 text-sm focus:outline-none focus:ring-1 focus:ring-[hsl(var(--brand))] text-[hsl(var(--text-1))]" />
              </div>
            </div>
            <div>
              <label className="text-xs font-semibold mb-1 block uppercase tracking-wide text-[hsl(var(--text-2))]">Meeting Type</label>
              <select value={mtgType} onChange={e => setMtgType(e.target.value)} className="w-full h-10 rounded-none border border-[hsl(var(--border))] bg-[hsl(var(--surface-2))] px-3 text-sm focus:outline-none focus:ring-1 focus:ring-[hsl(var(--brand))] text-[hsl(var(--text-1))]">
            ...
            <div>
              ...
              <Textarea value={mtgAttendees} onChange={e => setMtgAttendees(e.target.value)} className="text-sm bg-[hsl(var(--surface-2))] border-[hsl(var(--border))] text-[hsl(var(--text-1))] rounded-none min-h-[60px]" />
            </div>
            <div>
              <label className="text-xs font-semibold mb-1 block uppercase tracking-wide text-[hsl(var(--text-2))]">Agenda Items</label>
              <Textarea value={mtgAgenda} onChange={e => setMtgAgenda(e.target.value)} placeholder={`e.g.\n1. Review ${AGENDA_ITEMS.filter(a => a.status === 'pending').length} pending model approvals\n2. Q2 risk posture update\n3. SR 11-7 compliance review`} className="text-sm bg-[hsl(var(--surface-2))] border-[hsl(var(--border))] text-[hsl(var(--text-1))] rounded-none min-h-[80px]" />
            </div>
          ...
          <DialogFooter className="border-t border-[hsl(var(--border))] pt-5">
            <Button variant="outline" className="rounded-none border-[hsl(var(--border))] text-[hsl(var(--text-2))] hover:text-[hsl(var(--text-1))] hover:bg-[hsl(var(--surface-2))]" onClick={() => setScheduleOpen(false)}>Cancel</Button>
