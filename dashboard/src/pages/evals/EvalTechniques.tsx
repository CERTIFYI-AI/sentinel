  ...
  return (
    <div className="p-6 max-w-7xl mx-auto" style={{ fontFamily: 'Outfit, Inter, system-ui, sans-serif' }}>
      ...
      <div className="bg-white rounded-xl border shadow-sm"><table className="w-full text-sm text-gray-900">
        <thead className="bg-gray-50 text-gray-600"><tr><th className="p-3 text-left">Technique</th><th className="p-3 text-left">Category</th><th className="p-3 text-left">Models Tested</th><th className="p-3 text-left">Pass Rate</th><th className="p-3 text-left">Last Run</th><th className="p-3 text-left">Status</th></tr></thead>
