  ...
  return (
    <div className="p-6 max-w-7xl mx-auto" style={{ fontFamily: 'Inter, Outfit, system-ui, sans-serif' }}>
      ...
      <div className="bg-white rounded-xl border shadow-sm"><table className="w-full text-sm">
        <thead className="bg-gray-50"><tr><th className="p-3 text-left">Model</th><th className="p-3 text-left">Accuracy</th><th className="p-3 text-left">Latency</th><th className="p-3 text-left">Throughput</th><th className="p-3 text-left">Bias Score</th><th className="p-3 text-left">Last Eval</th></tr></thead>
