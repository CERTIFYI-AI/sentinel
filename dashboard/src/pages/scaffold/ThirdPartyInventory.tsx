...
//
// WS2 — Third-Party Inventory (scaffolded page).
// Category: Vendors
//
...
export default function ThirdPartyInventory() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Registered vendors, data-sharing scope, and risk tier."
      icon={UsersThree}
      breadcrumb={[{ label: "Vendors" }, { label: "Third-Party Inventory" }]}
    ...
    >
      <section aria-label="Third-Party Inventory records">
