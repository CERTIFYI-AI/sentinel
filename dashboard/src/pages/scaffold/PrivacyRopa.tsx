...
//
// WS2 — Records of Processing (scaffolded page).
// Category: Privacy
//
...
export default function PrivacyRopa() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Article 30 ROPA register and review status."
      icon={ListChecks}
      breadcrumb={[{ label: "Privacy" }, { label: "Records of Processing" }]}
    ...
    >
      <section aria-label="Records of Processing records">
