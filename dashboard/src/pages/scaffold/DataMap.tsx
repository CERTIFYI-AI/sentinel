...
export default function DataMap() {
  ...
  return (
    <ModuleScaffold
      title="Data Map"
      subtitle="Systems, stores, and data flows across the estate."
      icon={Graph}
      breadcrumb={[{ label: "Data" }, { label: "Data Map" }]}
    ...
    >
      <section aria-label="Data Map records">
