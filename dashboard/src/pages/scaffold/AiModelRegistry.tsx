...
//
// WS2 — Model Registry (scaffolded page).
// Category: AI
//
...
export default function AiModelRegistry() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Registered models, owners, and production status."
      icon={Robot}
      breadcrumb={[{ label: "AI" }, { label: "Model Registry" }]}
    ...
    >
      <section aria-label="Model Registry records">
