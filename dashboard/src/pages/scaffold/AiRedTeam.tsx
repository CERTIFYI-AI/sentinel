...
//
// WS2 — AI Red Team (scaffolded page).
// Category: AI
//
...
export default function AiRedTeam() {
  ...
  return (
    <ModuleScaffold
      title="AI Red Team"
      subtitle="Adversarial test campaigns and regression tracking."
      icon={Target}
      breadcrumb={[{ label: "AI" }, { label: "AI Red Team" }]}
    ...
    >
      <section aria-label="AI Red Team records">
