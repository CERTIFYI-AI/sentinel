...
//
// WS2 — SOX IT General Controls (scaffolded page).
// Category: Assurance
//
...
export default function SoxItGc() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Change, access, and operations controls for SOX programs."
      icon={ShieldCheck}
      breadcrumb={[{ label: "Assurance" }, { label: "SOX IT General Controls" }]}
    ...
    >
      <section aria-label="SOX IT General Controls records">
