...
//
// WS2 — Training Programs (scaffolded page).
// Category: Training
//
...
export default function TrainingPrograms() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Role-based training catalog and completion metrics."
      icon={GraduationCap}
      breadcrumb={[{ label: "Training" }, { label: "Training Programs" }]}
    ...
    >
      <section aria-label="Training Programs records">
