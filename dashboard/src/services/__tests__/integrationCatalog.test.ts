  ...
  it('ships a form for each provider the server accepts', () => {
    ...
    expect(INTEGRATIONS.map(i => i.id).sort()).toEqual(
      ['1password', '1password_device_trust_kolide',
       'addigy', 'aikido', 'anthropic_claude_api', 'anthropic_claude_console',
       'aqua_security', 'arize_ai_phoenix', 'auth0',
       'aws', 'aws_bedrock', 'aws_secrets_manager',
       'azure_devops', 'azure_key_vault',
       'bitbucket_pipelines', 'bitsight',
       'checkmarx', 'confluence', 'confluence_access_control',
       'crowdstrike', 'cursor_codeium', 'cyberark',
       'datadog', 'duo',
       'elastic_security', 'fleetdm',
       'gitguardian', 'github', 'github_copilot',
       'gitlab_ci_cd', 'gitlab_cloud', 'gitlab_self_managed', 'gitleaks',
       'google_chronicle', 'google_cloud_identity',
       'google_cloud_platform', 'google_cloud_vertex_ai',
       'google_drive', 'google_workspace',
       'grafana', 'graylog',
       'hexnode', 'hiddenlayer', 'hugging_face_enterprise',
       'jamf_pro', 'jira', 'jira_service_management',
       'jumpcloud', 'jumpcloud_mdm',
       'kandji_iru', 'keeper',
       'lacework', 'lakera_protect_ai', 'langsmith_langfuse', 'launchdarkly',
       'logrhythm',
       'manageengine', 'microsoft_azure', 'microsoft_defender_for_endpoint',
       ...
       'microsoft_teams', 'miradore', 'mosyle',
       'nessus', 'new_relic', 'ninjaone',
       'okta', 'omnissa_workspace_one',
       'one_identity', 'onelogin',
       'openai', 'openai_azure_openai', 'openvas', 'orca_security',
       'pinecone', 'ping_identity', 'pingone',
       'prisma_cloud', 'qualys',
       'rapid7_insightvm', 'rollbar',
       'sailpoint', 'securityscorecard', 'semgrep',
       'sentinelone', 'sentry', 'snyk', 'sonarqube',
       'splunk', 'splunk_enterprise', 'sumo_logic',
       'tailscale', 'tenable', 'tenable_vulnerability_management_fedramp',
       'trivy', 'trufflehog',
       'veracode', 'vmware_workspace_one',
       'weaviate', 'weights_biases_w_b', 'wiz'],
    )
  })
