  ...
  it('ships a form for each provider the server accepts', () => {
    ...
    expect(INTEGRATIONS.map(i => i.id).sort()).toEqual(
      ['1password', '1password_device_trust_kolide', '7shifts',
       'addigy', 'adp', 'adp_workforce_now', 'aikido', 'alexishr',
       'anthropic_claude_api', 'anthropic_claude_console',
       'aqua_security', 'arize_ai_phoenix', 'auth0', 'aws',
       'aws_bedrock', 'aws_secrets_manager', 'azure_devops',
       'azure_key_vault', 'bamboohr', 'bitbucket_pipelines',
       'bitsight', 'charthop', 'checkmarx', 'confluence',
       'confluence_access_control', 'crowdstrike',
       'cursor_codeium', 'cyberark', 'datadog', 'deel', 'duo',
       'elastic_security', 'employment_hero', 'factorial',
       'fleetdm', 'gitguardian', 'github', 'github_copilot',
       'gitlab_ci_cd', 'gitlab_cloud', 'gitlab_self_managed',
       'gitleaks', 'google_chronicle', 'google_cloud_identity',
       'google_cloud_platform', 'google_cloud_vertex_ai',
       'google_drive', 'google_workspace', 'grafana', 'graylog',
       'gusto', 'hexnode', 'hibob', 'hiddenlayer',
       'hugging_face_enterprise', 'humaans', 'isolved',
       'jamf_pro', 'jira', 'jira_service_management', 'jumpcloud',
       'jumpcloud_mdm', 'justworks', 'kandji_iru', 'keeper',
       'kenjo', 'lacework', 'lakera_protect_ai',
       'langsmith_langfuse', 'launchdarkly', 'logrhythm',
       'manageengine', 'microsoft_azure',
       ...
       'microsoft_sharepoint', 'microsoft_teams', 'miradore',
       'mosyle', 'nessus', 'netsuite', 'new_relic', 'ninjaone',
       'okta', 'omnissa_workspace_one', 'one_identity',
       'onelogin', 'openai', 'openai_azure_openai', 'openvas',
       'orca_security', 'paychex', 'payfit', 'personio',
       'pinecone', 'ping_identity', 'pingone', 'prisma_cloud',
       'proliant', 'qualys', 'rapid7_insightvm', 'rippling',
       'rollbar', 'sailpoint', 'sap_successfactors',
       'securityscorecard', 'semgrep', 'sentinelone', 'sentry',
       'snyk', 'sonarqube', 'splunk', 'splunk_enterprise',
       'square_payroll', 'sumo_logic', 'tailscale', 'tenable',
       'tenable_vulnerability_management_fedramp', 'trinet',
       'trivy', 'trufflehog', 'ukg', 'veracode',
       'vmware_workspace_one', 'weaviate', 'weights_biases_w_b',
       'wiz', 'workday'],
    )
  })
