...
export const modelsApi = {
  ...
  create: async (data: any) => {
    ...
    await logAction({ module: MODULE, entityType: 'models', entityId: result?.id, entityName: result?.name || result?.title, action: 'create', newValues: result });
    return result;
  },
  ...
  update: async (id: string, data: any) => {
    ...
    await logAction({ module: MODULE, entityType: 'models', entityId: id, action: 'update', newValues: data });
    return result;
  },
  ...
  delete: async (id: string, name?: string) => {
    ...
    await logAction({ module: MODULE, entityType: 'models', entityId: id, entityName: name, action: 'delete' });
  },
};
