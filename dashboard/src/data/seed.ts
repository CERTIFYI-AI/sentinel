...
export const USERS: User[] = [
  { id: 'U-001', name: 'Owner E', email: 'sarah.chen@certifyi.ai', role: 'CISO', department: 'Security', avatar: 'SC' },
  { id: 'U-002', name: 'Owner A', email: 'james.patel@certifyi.ai', role: 'VP Compliance', department: 'Compliance', avatar: 'JP' },
  { id: 'U-003', name: 'Owner D', email: 'maria.santos@certifyi.ai', role: 'ML Engineer', department: 'AI/ML', avatar: 'MS' },
  { id: 'U-004', name: 'Owner B', email: 'david.kim@certifyi.ai', role: 'Risk Analyst', department: 'Risk', avatar: 'DK' },
  { id: 'U-005', name: 'Owner F', email: 'emma.wilson@certifyi.ai', role: 'Auditor', department: 'Audit', avatar: 'EW' },
  { id: 'U-006', name: 'Owner C', email: 'raj.gupta@certifyi.ai', role: 'Model Risk Mgr', department: 'AI/ML', avatar: 'RG' },
];
...
export const MODELS: Model[] = [
  {
    ...
    owner: 'Owner D', status: 'production', riskTier: 'high', fairnessScore: 74,
  ...
  },
  {
    ...
    owner: 'Owner B', status: 'production', riskTier: 'high', fairnessScore: 91,
  ...
  },
  {
    ...
    owner: 'Owner D', status: 'staging', riskTier: 'limited', fairnessScore: 88,
  ...
  },
  {
    ...
    owner: 'Owner C', status: 'staging', riskTier: 'high', fairnessScore: 62,
  ...
  },
  {
    ...
    owner: 'Owner B', status: 'production', riskTier: 'high', fairnessScore: 85,
  ...
  },
  {
    ...
    owner: 'Owner D', status: 'production', riskTier: 'limited', fairnessScore: 93,
...
export const AGENTS: Agent[] = [
  { id: 'AGT-001', name: 'ModelMonitor-Prod', type: 'monitoring', model: 'Internal', risk: 'low', status: 'confirmed', apiCalls7d: 12400, owner: 'Owner D', department: 'AI/ML', description: 'Production model health monitoring and drift detection agent.', firstSeen: '2025-09-15', lastActive: '2026-03-31', dataAccess: ['model_metrics', 'performance_logs'] },
  { id: 'AGT-002', name: 'DataPipeline-Orchestrator', type: 'orchestrator', model: 'Internal', risk: 'medium', status: 'confirmed', apiCalls7d: 8200, owner: 'Owner B', department: 'Data Engineering', description: 'Orchestrates ETL pipelines for model training data.', firstSeen: '2025-10-01', lastActive: '2026-03-31', dataAccess: ['raw_data', 'processed_features'] },
  { id: 'AGT-003', name: 'Northwind AI-API-Connector', type: 'external_api', model: 'GPT-4o', risk: 'high', status: 'confirmed', apiCalls7d: 24500, owner: 'Owner C', department: 'AI/ML', description: 'External API connector for LLM-powered features.', firstSeen: '2025-11-20', lastActive: '2026-03-31', dataAccess: ['customer_queries', 'loan_applications'] },
  { id: 'AGT-004', name: 'FraudAlert-Watcher', type: 'monitoring', model: 'Internal', risk: 'medium', status: 'confirmed', apiCalls7d: 45200, owner: 'Owner B', department: 'Fraud Prevention', description: 'Real-time fraud alert monitoring and escalation.', firstSeen: '2025-08-10', lastActive: '2026-03-31', dataAccess: ['transaction_logs', 'fraud_labels'] },
  { id: 'AGT-005', name: 'ComplianceChecker-Bot', type: 'workflow', model: 'Internal', risk: 'low', status: 'confirmed', apiCalls7d: 3200, owner: 'Owner A', department: 'Compliance', description: 'Automated compliance policy checking workflow.', firstSeen: '2025-12-01', lastActive: '2026-03-30', dataAccess: ['policy_docs', 'control_mappings'] },
  { id: 'AGT-006', name: 'DataLabeler-v2', type: 'processing', model: 'Claude-3', risk: 'medium', status: 'confirmed', apiCalls7d: 15800, owner: 'Owner D', department: 'AI/ML', description: 'Automated data labeling for training datasets.', firstSeen: '2026-01-10', lastActive: '2026-03-31', dataAccess: ['training_data', 'label_store'] },
  { id: 'AGT-007', name: 'AuditLog-Streamer', type: 'monitoring', model: 'Internal', risk: 'low', status: 'confirmed', apiCalls7d: 2100, owner: 'Owner F', department: 'Audit', description: 'Streams audit events to SIEM and compliance dashboards.', firstSeen: '2025-07-15', lastActive: '2026-03-31', dataAccess: ['audit_events'] },
  { id: 'AGT-008', name: 'VendorRisk-Scanner', type: 'workflow', model: 'Internal', risk: 'medium', status: 'confirmed', apiCalls7d: 890, owner: 'Owner B', department: 'Risk', description: 'Automated vendor risk assessment scanning.', firstSeen: '2026-02-01', lastActive: '2026-03-28', dataAccess: ['vendor_data', 'risk_scores'] },
  { id: 'AGT-009', name: 'HRScreener-Agent', type: 'decision', model: 'GPT-4o', risk: 'high', status: 'confirmed', apiCalls7d: 1200, owner: 'Owner C', department: 'HR', description: 'Resume screening and candidate ranking. HIGH RISK — uses protected attributes.', firstSeen: '2026-01-20', lastActive: '2026-03-31', dataAccess: ['resumes', 'hr_records'] },
  // Shadow agents
...
export const DATASETS: Dataset[] = [
  { id: 'DS-001', name: 'Consumer Credit History v4', sensitivity: 'PII', classification: 'restricted', risk: 'critical', linkedModel: 'MDL-001', records: 2450000, status: 'active', lastAudit: '2026-02-15', owner: 'Owner B', encryption: 'AES-256', retentionPolicy: '7 years', description: 'Consumer credit bureau data for loan underwriting models.' },
  { id: 'DS-002', name: 'Transaction Fraud Labels v2', sensitivity: 'PII', classification: 'confidential', risk: 'high', linkedModel: 'MDL-002', records: 8900000, status: 'active', lastAudit: '2026-03-01', owner: 'Owner B', encryption: 'AES-256', retentionPolicy: '5 years', description: 'Labeled fraud/not-fraud transaction records for model training.' },
  { id: 'DS-003', name: 'Customer Behavioral Features', sensitivity: 'internal', classification: 'internal', risk: 'medium', linkedModel: 'MDL-003', records: 1200000, status: 'active', lastAudit: '2026-01-20', owner: 'Owner D', encryption: 'AES-256', retentionPolicy: '3 years', description: 'Aggregated customer behavior features for churn prediction.' },
  { id: 'DS-004', name: 'Policy Document Corpus', sensitivity: 'internal', classification: 'internal', risk: 'low', linkedModel: 'MDL-004', records: 34500, status: 'active', lastAudit: '2026-02-28', owner: 'Owner A', encryption: 'AES-128', retentionPolicy: '10 years', description: 'Internal policy and regulatory documents for LLM fine-tuning.' },
  { id: 'DS-005', name: 'AML Transaction History', sensitivity: 'PII', classification: 'restricted', risk: 'critical', linkedModel: 'MDL-005', records: 15600000, status: 'active', lastAudit: '2026-03-10', owner: 'Owner B', encryption: 'AES-256', retentionPolicy: '10 years', description: 'Full transaction history with SAR labels for AML monitoring.' },
  { id: 'DS-006', name: 'Customer Sentiment Corpus', sensitivity: 'internal', classification: 'internal', risk: 'low', linkedModel: 'MDL-006', records: 890000, status: 'active', lastAudit: '2026-02-10', owner: 'Owner D', encryption: 'AES-128', retentionPolicy: '2 years', description: 'Customer feedback and support tickets with sentiment labels.' },
  { id: 'DS-007', name: 'Employee HR Records 2023', sensitivity: 'PII', classification: 'restricted', risk: 'high', linkedModel: 'MDL-004', records: 4200, status: 'under_review', lastAudit: '2026-01-05', owner: 'Owner C', encryption: 'AES-256', retentionPolicy: '7 years', description: 'Employee records used for HR screening model training. Under ethical review.' },
  { id: 'DS-008', name: 'Vendor Contracts Archive', sensitivity: 'confidential', classification: 'confidential', risk: 'medium', linkedModel: '', records: 1250, status: 'active', lastAudit: '2026-03-05', owner: 'Owner A', encryption: 'AES-128', retentionPolicy: '10 years', description: 'Digitized vendor contracts and service agreements.' },
];
...
export const EVIDENCE: Evidence[] = [
  { id: 'EV-001', title: 'Bias Monitoring Report — Jan 2026', source: 'Automated evidence collection', framework: 'EU AI Act', control: 'Art. 10 — Data Governance', type: 'Report', status: 'synced', lastSync: '2026-03-15', owner: 'Owner D', description: 'Monthly bias monitoring report covering all production models.', fileSize: '2.4 MB' },
  { id: 'EV-002', title: 'SHAP Explainability Report', source: 'Cobalt.io', framework: 'EU AI Act', control: 'Art. 13 — Transparency', type: 'Report', status: 'synced', lastSync: '2026-03-10', owner: 'Owner C', description: 'SHAP-based model explainability analysis for high-risk systems.', fileSize: '1.8 MB' },
  { id: 'EV-003', title: 'Human Oversight Log Q1 2026', source: 'KeyGate Identity', framework: 'EU AI Act', control: 'Art. 14 — Human Oversight', type: 'Log', status: 'synced', lastSync: '2026-03-01', owner: 'Owner A', description: 'Quarterly human-in-the-loop review records for automated decisions.', fileSize: '890 KB' },
  { id: 'EV-004', title: 'Fraud Model Validation v2.1', source: 'Internal', framework: 'NIST AI RMF', control: 'MEASURE 2.6 — Bias', type: 'Validation', status: 'synced', lastSync: '2026-02-28', owner: 'Owner B', description: 'Independent validation report for Fraud Detection Engine v2.1.', fileSize: '3.1 MB' },
  { id: 'EV-005', title: 'GDPR DPA Agreement — Northwind AI', source: 'Legal', framework: 'GDPR', control: 'Art. 28 — Processor', type: 'Agreement', status: 'expired', lastSync: '2025-12-01', owner: 'Owner A', description: 'Data Processing Agreement with Northwind AI. EXPIRED — renewal required.', fileSize: '456 KB' },
  { id: 'EV-006', title: 'SOC 2 Type II — AWS 2025', source: 'AWS', framework: 'ISO 27001', control: 'A.15.2 — Supplier Delivery', type: 'Certificate', status: 'pending', lastSync: '2026-01-15', owner: 'Owner E', description: 'AWS SOC 2 Type II attestation report. Pending annual renewal.', fileSize: '5.2 MB' },
];
...
export const INCIDENTS: Incident[] = [
  { id: 'INC-001', title: 'Bias in Credit Scoring Output', severity: 'critical', status: 'investigating', category: 'Bias/Fairness', reportedDate: '2026-01-08', reporter: 'Owner D', assignee: 'Owner C', description: 'Credit Risk Scorer showing statistically significant disparate impact on protected class.', linkedModel: 'MDL-001', rootCause: 'Geographic proxy features correlating with protected attributes.', correctiveActions: ['Feature audit initiated', 'Model suspended from auto-decisions', 'Bias audit BA-001 scheduled'], timeline: [{ date: '2026-01-08', action: 'Incident reported', actor: 'Owner D' }, { date: '2026-01-09', action: 'Severity escalated to Critical', actor: 'Owner E' }, { date: '2026-01-10', action: 'Model placed in human-review mode', actor: 'Owner C' }] },
  { id: 'INC-002', title: 'Fraud Model Latency Spike', severity: 'medium', status: 'resolved', category: 'Performance', reportedDate: '2026-01-10', reporter: 'Owner B', assignee: 'Owner D', description: 'Fraud Detection Engine response time exceeded 500ms during peak hours.', linkedModel: 'MDL-002', rootCause: 'Auto-scaling policy not configured for burst traffic pattern.', correctiveActions: ['Auto-scaling policy updated', 'Cache layer implemented', 'Load testing completed'], timeline: [{ date: '2026-01-10', action: 'Incident reported', actor: 'Owner B' }, { date: '2026-01-11', action: 'Root cause identified', actor: 'Owner D' }, { date: '2026-01-15', action: 'Fix deployed and verified', actor: 'Owner D' }] },
  { id: 'INC-003', title: 'Shadow AI Unauthorized Data Access', severity: 'high', status: 'open', category: 'Security', reportedDate: '2026-01-15', reporter: 'Owner E', assignee: 'Owner E', description: 'Unauthorized LangChain agent detected accessing customer PII in marketing department.', linkedModel: '', rootCause: 'Marketing team deployed unapproved LLM agent without IT review.', correctiveActions: ['Agent quarantined', 'Data access revoked', 'Department audit initiated'], timeline: [{ date: '2026-01-15', action: 'Shadow agent detected by network scan', actor: 'System' }, { date: '2026-01-15', action: 'Incident opened', actor: 'Owner E' }] },
  { id: 'INC-004', title: 'HR Model Gender Bias Flag', severity: 'critical', status: 'investigating', category: 'Bias/Fairness', reportedDate: '2026-02-03', reporter: 'Owner C', assignee: 'Owner D', description: 'Loan Approval Assistant in HR screening mode showing significant gender and age bias.', linkedModel: 'MDL-004', rootCause: 'Training data contains historical hiring bias patterns.', correctiveActions: ['HR screening feature suspended', 'Bias audit BA-003 and BA-005 initiated', 'Legal review requested'], timeline: [{ date: '2026-02-03', action: 'Bias detected in production monitoring', actor: 'Owner C' }, { date: '2026-02-03', action: 'HR screening suspended', actor: 'Owner E' }, { date: '2026-02-05', action: 'Bias audit scheduled', actor: 'Owner F' }] },
  { id: 'INC-005', title: 'LLM Hallucination in Loan Approval', severity: 'high', status: 'mitigating', category: 'AI Safety', reportedDate: '2026-03-01', reporter: 'Owner A', assignee: 'Owner C', description: 'Loan Approval Assistant fabricated non-existent regulatory requirements in approval reasoning.', linkedModel: 'MDL-004', rootCause: 'LLM generating plausible but false regulatory citations.', correctiveActions: ['RAG pipeline implementation in progress', 'Human review mandatory for all outputs', 'Citation verification system planned'], timeline: [{ date: '2026-03-01', action: 'Hallucination detected in audit sample', actor: 'Owner A' }, { date: '2026-03-02', action: 'Human review gate enabled', actor: 'Owner C' }, { date: '2026-03-10', action: 'RAG pipeline design approved', actor: 'Owner D' }] },
];
...
export const AUDIT_LOG: AuditEntry[] = [
  { id: 'AL-001', action: 'Model updated', entity: 'Credit Risk Scorer', entityId: 'MDL-001', actor: 'Owner E', timestamp: '2026-01-15T15:15:00Z', category: 'model', details: 'Updated risk tier from Limited to High after EU AI Act reclassification.' },
  { id: 'AL-002', action: 'Risk created', entity: 'PII consent gap', entityId: 'RSK-003', actor: 'Owner A', timestamp: '2026-01-18T10:30:00Z', category: 'risk', details: 'New compliance risk identified during GDPR audit.' },
  { id: 'AL-003', action: 'Policy approved', entity: 'AI Acceptable Use Policy', entityId: 'POL-001', actor: 'Owner F', timestamp: '2026-01-20T14:00:00Z', category: 'policy', details: 'Policy approved after 3-reviewer workflow completion.' },
  { id: 'AL-004', action: 'Bias audit completed', entity: 'Credit Risk Scorer', entityId: 'BA-001', actor: 'Owner D', timestamp: '2026-01-22T11:45:00Z', category: 'bias_audit', details: 'Bias audit BA-001 completed. Result: FAILED. Remediation required.' },
  { id: 'AL-005', action: 'Vendor added', entity: 'Summit Industrial AI', entityId: 'V-007', actor: 'Owner B', timestamp: '2026-02-01T09:20:00Z', category: 'vendor', details: 'New vendor registered. Flagged as HIGH RISK — DPA not signed.' },
  { id: 'AL-006', action: 'Incident reported', entity: 'HR Model Gender Bias Flag', entityId: 'INC-004', actor: 'Owner C', timestamp: '2026-02-03T08:15:00Z', category: 'incident', details: 'Critical bias incident in Loan Approval Assistant HR screening mode.' },
  { id: 'AL-007', action: 'Control updated', entity: 'CTRL-004 Risk Assessment', entityId: 'CTRL-004', actor: 'Owner A', timestamp: '2026-02-15T16:30:00Z', category: 'control', details: 'Control status changed from Planned to Partial. Evidence uploaded.' },
  { id: 'AL-008', action: 'Evidence synced', entity: 'Human Oversight Log Q1 2026', entityId: 'EV-003', actor: 'System', timestamp: '2026-03-01T00:00:00Z', category: 'evidence', details: 'Automated sync from KeyGate Identity completed successfully.' },
];
...
export const THREATS: Threat[] = [
  ...
  { id: 'THR-002', name: 'API Key Exposure in Logs', category: 'Data Exposure', severity: 'high', status: 'resolved', source: 'Vendor Advisory', detected: '2026-02-05', description: 'Northwind AI API keys found in application debug logs.', affectedModels: ['MDL-004'], remediation: ['Keys rotated', 'Log scrubbing enabled', 'Secret scanning added to CI'] },
...
export const VULNERABILITIES: Vulnerability[] = [
  { id: 'VULN-001', cve: 'CVE-2026-1234', title: 'SQL Injection in Model API', cvss: 9.1, severity: 'critical', component: 'model-api v2.3.1', status: 'patched', discovered: '2026-01-20', patchDate: '2026-01-22', assignee: 'Owner D', description: 'Critical SQL injection in prediction endpoint allowing arbitrary query execution.' },
  { id: 'VULN-002', cve: 'CVE-2026-5678', title: 'Tokenizer Buffer Overflow', cvss: 7.3, severity: 'high', component: 'transformers v4.38.1', status: 'in_progress', discovered: '2026-02-10', patchDate: '', assignee: 'Owner B', description: 'Buffer overflow in tokenizer library allowing denial of service.' },
  { id: 'VULN-003', cve: 'CVE-2026-9012', title: 'LangChain RCE via Template', cvss: 6.5, severity: 'medium', component: 'langchain v0.1.12', status: 'open', discovered: '2026-02-28', patchDate: '', assignee: 'Owner D', description: 'Remote code execution via malicious prompt templates in LangChain.' },
  { id: 'VULN-004', cve: 'SENT-V-004', title: 'Insecure Model Deserialization', cvss: 8.2, severity: 'high', component: 'model-loader v1.0', status: 'in_progress', discovered: '2026-03-01', patchDate: '', assignee: 'Owner C', description: 'Pickle deserialization vulnerability in custom model loading pipeline.' },
  { id: 'VULN-005', cve: 'SENT-V-005', title: 'Missing Rate Limiting on Inference', cvss: 5.8, severity: 'medium', component: 'inference-gateway v3.1', status: 'open', discovered: '2026-03-05', patchDate: '', assignee: 'Owner B', description: 'No rate limiting on model inference API allowing resource exhaustion.' },
  { id: 'VULN-006', cve: 'CVE-2026-6103', title: 'Vector DB Injection in ChromaDB', cvss: 7.8, severity: 'high', component: 'chromadb v0.4.22', status: 'open', discovered: '2026-03-12', patchDate: '', assignee: 'Owner D', description: 'Metadata injection vulnerability in ChromaDB vector store queries.' },
];
...
export const RED_TEAM_EXERCISES: RedTeamExercise[] = [
  { id: 'RT-001', name: 'LLM Jailbreak Test — Jan 2026', attackVector: 'Prompt Injection / Jailbreak', status: 'completed', findings: 12, criticalFindings: 3, lead: 'Owner E', startDate: '2026-01-15', endDate: '2026-01-25', targetModel: 'MDL-004', description: 'Comprehensive jailbreak testing of Loan Approval Assistant using DAN, AIM, and custom bypass prompts.', score: 45 },
  { id: 'RT-002', name: 'API Auth Bypass — Feb 2026', attackVector: 'Authentication Bypass', status: 'completed', findings: 5, criticalFindings: 1, lead: 'Owner B', startDate: '2026-02-01', endDate: '2026-02-10', targetModel: 'MDL-001', description: 'Penetration testing of model API authentication and authorization controls.', score: 78 },
  { id: 'RT-003', name: 'Data Exfil Simulation — Mar 2026', attackVector: 'Data Exfiltration', status: 'completed', findings: 8, criticalFindings: 2, lead: 'Owner E', startDate: '2026-03-01', endDate: '2026-03-15', targetModel: '', description: 'Simulated data exfiltration scenarios testing DLP and network controls.', score: 62 },
  { id: 'RT-004', name: 'Prompt Injection Campaign — Mar 2026', attackVector: 'Prompt Injection', status: 'active', findings: 9, criticalFindings: 4, lead: 'Owner C', startDate: '2026-03-20', endDate: '', targetModel: 'MDL-004', description: 'Ongoing adversarial prompt injection campaign against all LLM-based systems.', score: 38 },
];
...
export const ATTACK_SURFACE: AttackSurfaceAsset[] = [
  { id: 'AS-001', name: 'app.example.com', type: 'Web Application', exposure: 'public', risk: 'medium', protocol: 'HTTPS', lastScanned: '2026-03-28', status: 'monitored', owner: 'Owner E', description: 'Primary GRC platform web application.', openPorts: 2 },
  { id: 'AS-002', name: 'api.example.com', type: 'API Gateway', exposure: 'public', risk: 'high', protocol: 'HTTPS/REST', lastScanned: '2026-03-28', status: 'monitored', owner: 'Owner D', description: 'Model inference and platform API gateway.', openPorts: 1 },
  { id: 'AS-003', name: 'mlops-prod.internal', type: 'ML Pipeline', exposure: 'internal', risk: 'high', protocol: 'gRPC', lastScanned: '2026-03-25', status: 'monitored', owner: 'Owner D', description: 'Production ML operations pipeline and model registry.', openPorts: 3 },
  { id: 'AS-004', name: 'data-warehouse.internal', type: 'Data Store', exposure: 'internal', risk: 'critical', protocol: 'PostgreSQL', lastScanned: '2026-03-28', status: 'monitored', owner: 'Owner B', description: 'Primary data warehouse with PII datasets.', openPorts: 1 },
  { id: 'AS-005', name: 'vendor-portal.example.com', type: 'Web Application', exposure: 'public', risk: 'medium', protocol: 'HTTPS', lastScanned: '2026-03-20', status: 'monitored', owner: 'Owner A', description: 'Vendor self-service portal for questionnaire responses.', openPorts: 2 },
  { id: 'AS-006', name: 'admin.example.com', type: 'Admin Panel', exposure: 'restricted', risk: 'critical', protocol: 'HTTPS', lastScanned: '2026-03-28', status: 'monitored', owner: 'Owner E', description: 'Administrative control panel with elevated privileges.', openPorts: 1 },
  { id: 'AS-007', name: 'cdn.example.com', type: 'CDN', exposure: 'public', risk: 'low', protocol: 'HTTPS', lastScanned: '2026-03-15', status: 'monitored', owner: 'Owner D', description: 'Content delivery network for static assets.', openPorts: 1 },
  { id: 'AS-008', name: 'monitoring.example.com', type: 'Monitoring', exposure: 'internal', risk: 'medium', protocol: 'HTTPS', lastScanned: '2026-03-28', status: 'monitored', owner: 'Owner E', description: 'Observability and monitoring dashboard.', openPorts: 2 },
];
...
export interface Control {
  ...
  // Optional atomic-control governance metadata (from the compliance library).
  code?: string; severity?: 'CRITICAL' | 'HIGH' | 'MEDIUM' | 'LOW'; evalType?: 'AUTO' | 'MANUAL';
}
export const CONTROLS: Control[] = [
  { id: 'CTRL-001', title: 'AI System Risk Classification', framework: 'EU AI Act', clause: 'Art. 6', status: 'implemented', score: 95, owner: 'Owner A', evidenceCount: 22, lastTested: '2026-03-15', description: 'Classify all AI systems by risk level per EU AI Act categories.', testResult: 'pass' },
  { id: 'CTRL-002', title: 'Data Governance for AI Training', framework: 'EU AI Act', clause: 'Art. 10', status: 'implemented', score: 88, owner: 'Owner B', evidenceCount: 18, lastTested: '2026-03-10', description: 'Ensure training data quality, relevance, and representativeness.', testResult: 'pass' },
  { id: 'CTRL-003', title: 'Transparency & Documentation', framework: 'EU AI Act', clause: 'Art. 13', status: 'partial', score: 72, owner: 'Owner C', evidenceCount: 15, lastTested: '2026-03-08', description: 'Provide transparent information about AI system capabilities and limitations.', testResult: 'fail' },
  { id: 'CTRL-004', title: 'Human Oversight Mechanisms', framework: 'EU AI Act', clause: 'Art. 14', status: 'implemented', score: 91, owner: 'Owner A', evidenceCount: 31, lastTested: '2026-03-12', description: 'Enable human oversight and intervention in AI-assisted decisions.', testResult: 'pass' },
  { id: 'CTRL-005', title: 'Accuracy & Robustness Testing', framework: 'NIST AI RMF', clause: 'MEASURE 1.1', status: 'implemented', score: 94, owner: 'Owner D', evidenceCount: 28, lastTested: '2026-03-20', description: 'Regular accuracy, robustness, and reliability testing of AI models.', testResult: 'pass' },
  { id: 'CTRL-006', title: 'Bias & Fairness Monitoring', framework: 'NIST AI RMF', clause: 'MEASURE 2.6', status: 'partial', score: 68, owner: 'Owner D', evidenceCount: 14, lastTested: '2026-03-18', description: 'Continuous monitoring of bias metrics across protected attributes.', testResult: 'fail' },
  { id: 'CTRL-007', title: 'Information Security Controls', framework: 'ISO 27001', clause: 'A.8.1', status: 'implemented', score: 96, owner: 'Owner E', evidenceCount: 42, lastTested: '2026-03-25', description: 'Asset management and information security controls for AI systems.', testResult: 'pass' },
  { id: 'CTRL-008', title: 'Access Control & Authentication', framework: 'ISO 27001', clause: 'A.9.1', status: 'implemented', score: 92, owner: 'Owner E', evidenceCount: 35, lastTested: '2026-03-22', description: 'Role-based access control for AI systems and data.', testResult: 'pass' },
  { id: 'CTRL-009', title: 'Supplier Relationships', framework: 'ISO 27001', clause: 'A.15.2', status: 'partial', score: 74, owner: 'Owner A', evidenceCount: 12, lastTested: '2026-03-05', description: 'Manage security aspects of vendor and supplier relationships.', testResult: 'fail' },
  { id: 'CTRL-010', title: 'Security Operations', framework: 'SOC 2', clause: 'CC6.6', status: 'implemented', score: 90, owner: 'Owner E', evidenceCount: 38, lastTested: '2026-03-28', description: 'Security operations and monitoring for trust service criteria.', testResult: 'pass' },
  { id: 'CTRL-011', title: 'Change Management', framework: 'SOC 2', clause: 'CC8.1', status: 'implemented', score: 87, owner: 'Owner F', evidenceCount: 22, lastTested: '2026-03-15', description: 'Change management procedures for AI system updates.', testResult: 'pass' },
  { id: 'CTRL-012', title: 'Prompt Injection Prevention', framework: 'OWASP LLM', clause: 'LLM01', status: 'partial', score: 65, owner: 'Owner D', evidenceCount: 8, lastTested: '2026-03-20', description: 'Prevent prompt injection attacks on LLM-based systems.', testResult: 'fail' },
  { id: 'CTRL-013', title: 'Sensitive Information Disclosure', framework: 'OWASP LLM', clause: 'LLM06', status: 'planned', score: 40, owner: 'Owner C', evidenceCount: 3, lastTested: '', description: 'Prevent LLMs from disclosing sensitive information in outputs.', testResult: 'pending' },
  { id: 'CTRL-014', title: 'Model Inventory & Lifecycle', framework: 'NIST AI RMF', clause: 'GOVERN 1.2', status: 'implemented', score: 93, owner: 'Owner C', evidenceCount: 25, lastTested: '2026-03-18', description: 'Maintain comprehensive inventory of all AI models and lifecycle tracking.', testResult: 'pass' },
  { id: 'CTRL-015', title: 'Automated Decision Rights', framework: 'GDPR', clause: 'Art. 22', status: 'partial', score: 58, owner: 'Owner A', evidenceCount: 9, lastTested: '2026-02-28', description: 'Ensure individual rights around automated decision-making.', testResult: 'fail' },
...
export const POLICIES: Policy[] = [
  { id: 'POL-001', title: 'AI Acceptable Use Policy', category: 'AI Usage', status: 'published', version: 'v2.1', owner: 'Owner A', framework: 'ISO/IEC 42001', lastReview: '2026-01-20', nextReview: '2026-07-20', approver: 'Owner E', description: 'Defines acceptable use of AI systems across the organization.' },
  { id: 'POL-002', title: 'Model Risk Management Policy', category: 'Risk', status: 'published', version: 'v1.3', owner: 'Owner C', framework: 'NIST AI RMF', lastReview: '2026-02-15', nextReview: '2026-08-15', approver: 'Owner E', description: 'Policy governing AI/ML model risk assessment, validation, and monitoring.' },
  { id: 'POL-003', title: 'Data Privacy for AI Policy', category: 'Data Privacy', status: 'published', version: 'v2.0', owner: 'Owner A', framework: 'GDPR', lastReview: '2026-01-10', nextReview: '2026-07-10', approver: 'Owner F', description: 'Data privacy requirements for AI training data and model outputs.' },
  { id: 'POL-004', title: 'Bias & Fairness Policy', category: 'AI Ethics', status: 'published', version: 'v1.1', owner: 'Owner D', framework: 'EU AI Act', lastReview: '2026-03-01', nextReview: '2026-09-01', approver: 'Owner A', description: 'Standards for bias testing, fairness metrics, and remediation procedures.' },
  { id: 'POL-005', title: 'EU AI Act Compliance Framework', category: 'Regulatory', status: 'in_review', version: 'v0.9', owner: 'Owner F', framework: 'EU AI Act', lastReview: '2026-03-15', nextReview: '2026-06-15', approver: '', description: 'Comprehensive framework for EU AI Act compliance. Under review.' },
  { id: 'POL-006', title: 'Third-Party AI Vendor Policy', category: 'Vendor', status: 'published', version: 'v1.0', owner: 'Owner B', framework: 'ISO 27001', lastReview: '2026-02-01', nextReview: '2026-08-01', approver: 'Owner E', description: 'Requirements for third-party AI vendor assessment and ongoing monitoring.' },
  { id: 'POL-007', title: 'AI Incident Response Procedure', category: 'Incident', status: 'published', version: 'v1.2', owner: 'Owner E', framework: 'SOC 2', lastReview: '2026-01-25', nextReview: '2026-07-25', approver: 'Owner A', description: 'Incident response procedures for AI system failures and bias incidents.' },
  { id: 'POL-008', title: 'LLM Security Policy', category: 'Security', status: 'draft', version: 'v0.5', owner: 'Owner E', framework: 'OWASP LLM', lastReview: '', nextReview: '2026-05-01', approver: '', description: 'Security requirements for LLM deployment. Draft in progress.' },
  { id: 'POL-009', title: 'Human Oversight Policy', category: 'AI Governance', status: 'published', version: 'v1.0', owner: 'Owner A', framework: 'EU AI Act', lastReview: '2026-02-20', nextReview: '2026-08-20', approver: 'Owner F', description: 'Requirements for human oversight of high-risk AI systems.' },
  { id: 'POL-010', title: 'AI Model Documentation Standard', category: 'Documentation', status: 'in_review', version: 'v0.8', owner: 'Owner C', framework: 'EU AI Act', lastReview: '2026-03-10', nextReview: '2026-06-10', approver: '', description: 'Model card and technical documentation standards. Under review.' },
  { id: 'POL-011', title: 'Shadow AI Prevention Policy', category: 'Security', status: 'published', version: 'v1.0', owner: 'Owner E', framework: 'ISO 27001', lastReview: '2026-03-05', nextReview: '2026-09-05', approver: 'Owner A', description: 'Controls to detect and prevent unauthorized AI system deployments.' },
  { id: 'POL-012', title: 'AI Data Retention Policy', category: 'Data Privacy', status: 'draft', version: 'v0.3', owner: 'Owner A', framework: 'GDPR', lastReview: '', nextReview: '2026-05-15', approver: '', description: 'Data retention and deletion requirements for AI training data. Early draft.' },
];
...
export const HITL_REVIEWS: HITLReview[] = [
  { id: 'HITL-001', modelId: 'MDL-004', modelName: 'Loan Approval Assistant', type: 'Bias Review', trigger: 'Automated bias detection', priority: 'critical', status: 'pending', assignee: 'Owner D', sla: '4h remaining', riskScore: 94, createdDate: '2026-03-31', description: 'Critical bias threshold exceeded on gender dimension.' },
  { id: 'HITL-002', modelId: 'MDL-001', modelName: 'Credit Risk Scorer', type: 'Fairness Audit', trigger: 'Quarterly scheduled', priority: 'high', status: 'in_review', assignee: 'Owner C', sla: '12h remaining', riskScore: 82, createdDate: '2026-03-30', description: 'Quarterly fairness audit review for high-risk credit model.' },
  { id: 'HITL-003', modelId: 'MDL-002', modelName: 'Fraud Detection Engine', type: 'False Positive', trigger: 'Alert threshold', priority: 'medium', status: 'in_review', assignee: 'Owner B', sla: '24h remaining', riskScore: 65, createdDate: '2026-03-29', description: 'False positive rate exceeded 5% threshold for 3 consecutive days.' },
  { id: 'HITL-004', modelId: 'MDL-002', modelName: 'Fraud Detection Engine', type: 'Model Update', trigger: 'Version deployment', priority: 'medium', status: 'approved', assignee: 'Owner F', sla: 'Completed', riskScore: 45, createdDate: '2026-03-28', description: 'Pre-deployment review for Fraud Detection Engine v2.1 update.' },
  { id: 'HITL-005', modelId: 'MDL-003', modelName: 'Churn Predictor', type: 'Drift Review', trigger: 'Drift monitor alert', priority: 'low', status: 'pending', assignee: 'Owner D', sla: '48h remaining', riskScore: 38, createdDate: '2026-03-27', description: 'Minor input distribution drift detected in customer features.' },
  { id: 'HITL-006', modelId: 'MDL-004', modelName: 'Loan Approval Assistant', type: 'Regulatory', trigger: 'Compliance flag', priority: 'critical', status: 'escalated', assignee: 'Owner A', sla: 'Overdue', riskScore: 91, createdDate: '2026-03-26', description: 'EU AI Act compliance gap requires immediate human review.' },
  { id: 'HITL-007', modelId: 'MDL-005', modelName: 'AML Transaction Monitor', type: 'Threshold Review', trigger: 'Performance alert', priority: 'high', status: 'pending', assignee: 'Owner B', sla: '8h remaining', riskScore: 71, createdDate: '2026-03-25', description: 'SAR filing threshold review requested by compliance.' },
  { id: 'HITL-008', modelId: 'MDL-006', modelName: 'Customer Sentiment Analyzer', type: 'Quality Check', trigger: 'Scheduled QA', priority: 'low', status: 'approved', assignee: 'Owner F', sla: 'Completed', riskScore: 22, createdDate: '2026-03-24', description: 'Routine quality assurance check. All metrics within bounds.' },
];
...
export const GAPS: Gap[] = [
  { id: 'GAP-001', title: 'Risk assessment not updated for LLM deployment scenarios', framework: 'EU AI Act', controlRef: 'Art. 9', severity: 'critical', progress: 25, dueDate: '2026-04-30', owner: 'Owner C', description: 'Current risk assessment methodology does not adequately cover LLM-specific risks.' },
  { id: 'GAP-002', title: 'Model transparency documentation incomplete for high-risk systems', framework: 'EU AI Act', controlRef: 'Art. 13', severity: 'critical', progress: 40, dueDate: '2026-05-15', owner: 'Owner C', description: 'Technical documentation does not meet Article 13 transparency requirements.' },
  { id: 'GAP-003', title: 'Automated decision explainability gap — GDPR Art. 22', framework: 'GDPR', controlRef: 'Art. 22', severity: 'high', progress: 15, dueDate: '2026-04-20', owner: 'Owner A', description: 'No meaningful explanation provided for automated credit decisions.' },
  { id: 'GAP-004', title: 'Training data governance for bias prevention', framework: 'EU AI Act', controlRef: 'Art. 10', severity: 'high', progress: 55, dueDate: '2026-05-01', owner: 'Owner B', description: 'Data governance procedures do not adequately address representativeness requirements.' },
  { id: 'GAP-005', title: 'Vendor AI processing agreements need DPA updates', framework: 'GDPR', controlRef: 'Art. 28', severity: 'critical', progress: 10, dueDate: '2026-04-15', owner: 'Owner A', description: 'DPA with Northwind AI expired. Other vendor DPAs need AI-specific clauses.' },
  { id: 'GAP-006', title: 'Incident response procedure lacks AI-specific playbooks', framework: 'SOC 2', controlRef: 'CC7.3', severity: 'high', progress: 60, dueDate: '2026-05-10', owner: 'Owner E', description: 'Incident response does not cover AI-specific scenarios like bias incidents.' },
  { id: 'GAP-007', title: 'LLM prompt injection testing not formalized', framework: 'OWASP LLM', controlRef: 'LLM01', severity: 'high', progress: 30, dueDate: '2026-04-25', owner: 'Owner D', description: 'No formal process for regular prompt injection testing of LLM systems.' },
  { id: 'GAP-008', title: 'Human oversight mechanisms need expansion', framework: 'EU AI Act', controlRef: 'Art. 14', severity: 'medium', progress: 70, dueDate: '2026-05-20', owner: 'Owner A', description: 'Human oversight currently only covers credit decisions. Needs expansion to all high-risk uses.' },
  { id: 'GAP-009', title: 'Model inventory lacks lifecycle tracking', framework: 'NIST AI RMF', controlRef: 'GOVERN 1.2', severity: 'medium', progress: 45, dueDate: '2026-05-01', owner: 'Owner C', description: 'Model lifecycle phases not systematically tracked from development to retirement.' },
  { id: 'GAP-010', title: 'Shadow AI detection needs automated monitoring', framework: 'ISO 27001', controlRef: 'A.8.1', severity: 'high', progress: 20, dueDate: '2026-04-30', owner: 'Owner E', description: 'Current shadow AI detection is manual. Need automated network scanning.' },
];
...
export const HITL_ITEMS: HITLItem[] = [
  { id: 'HT-001', entityType: 'model', entityId: 'MDL-004', entityName: 'Loan Approval Assistant', triggerReason: 'Critical bias threshold exceeded — Gender Parity 0.72 < 0.85', assignedTo: 'Owner D', slaDeadline: '2026-04-06T18:00:00Z', priority: 'critical', status: 'pending', remarks: '', overdue: false, createdDate: '2026-04-06T08:00:00Z', history: [{ date: '2026-04-06T08:00:00Z', action: 'Review queued — automated bias detection trigger', by: 'System' }] },
  { id: 'HT-002', entityType: 'model', entityId: 'MDL-001', entityName: 'Credit Risk Scorer', triggerReason: 'Quarterly fairness audit — scheduled review', assignedTo: 'Owner C', slaDeadline: '2026-04-05T12:00:00Z', priority: 'high', status: 'pending', remarks: '', overdue: true, createdDate: '2026-04-04T09:00:00Z', history: [{ date: '2026-04-04T09:00:00Z', action: 'Quarterly audit scheduled', by: 'System' }] },
  { id: 'HT-003', entityType: 'agent', entityId: 'AGT-010', entityName: 'LangChain-Marketing', triggerReason: 'Shadow AI detected — unauthorized agent accessing customer PII', assignedTo: 'Owner E', slaDeadline: '2026-04-06T20:00:00Z', priority: 'critical', status: 'pending', remarks: '', overdue: false, createdDate: '2026-04-06T10:00:00Z', history: [{ date: '2026-04-06T10:00:00Z', action: 'Shadow AI flagged for review', by: 'System' }] },
  { id: 'HT-004', entityType: 'incident', entityId: 'INC-005', entityName: 'LLM Hallucination — Loan Terms', triggerReason: 'Open hallucination incident requires HITL validation', assignedTo: 'Owner A', slaDeadline: '2026-04-04T10:00:00Z', priority: 'high', status: 'pending', remarks: '', overdue: true, createdDate: '2026-04-03T14:00:00Z', history: [{ date: '2026-04-03T14:00:00Z', action: 'Incident escalated to HITL queue', by: 'Owner B' }] },
  { id: 'HT-005', entityType: 'model', entityId: 'MDL-002', entityName: 'Fraud Detection Engine', triggerReason: 'Pre-deployment review for v2.1 update', assignedTo: 'Owner F', slaDeadline: '2026-04-07T16:00:00Z', priority: 'medium', status: 'approved', remarks: 'All metrics within bounds. Approved for production deployment.', overdue: false, createdDate: '2026-04-05T11:00:00Z', history: [{ date: '2026-04-05T11:00:00Z', action: 'Deployment review requested', by: 'Owner D' }, { date: '2026-04-06T09:00:00Z', action: 'Approved — all checks passed', by: 'Owner F' }] },
  { id: 'HT-006', entityType: 'dataset', entityId: 'DS-007', entityName: 'Employee HR Records 2023', triggerReason: 'PII dataset used in model training — ethical review required', assignedTo: 'Owner B', slaDeadline: '2026-04-08T12:00:00Z', priority: 'medium', status: 'pending', remarks: '', overdue: false, createdDate: '2026-04-05T16:00:00Z', history: [{ date: '2026-04-05T16:00:00Z', action: 'Ethical review requested for PII training data', by: 'Owner C' }] },
];
...
export const PROMPT_REGISTRY: PromptRecord[] = [
  {
    ...
    versions: [
      { version: '3.2.1', content: 'Current version. Added FCRA §615 adverse action language.', author: 'Owner A', changedAt: '2026-03-15T10:30:00Z', changeNote: 'Added explicit FCRA adverse action reason requirements per Legal review LGL-2026-011.' },
      { version: '3.2.0', content: 'Added DTI threshold constraints and LTV limits.', author: 'Owner A', changedAt: '2026-02-10T09:00:00Z', changeNote: 'Updated underwriting criteria to reflect Policy v2.4 changes.' },
      { version: '3.1.0', content: 'Initial ECOA compliance update.', author: 'Owner C', changedAt: '2025-12-01T14:00:00Z', changeNote: 'Baseline fair lending language added post-compliance audit.' },
    ],
  },
  {
    id: 'PR-002',
    ...
    versions: [
      { version: '2.1.0', content: 'Added anti-jailbreak detection and confidence hedging rules.', author: 'Owner C', changedAt: '2026-04-01T11:00:00Z', changeNote: 'Red team exercise RT-2026-03 identified jailbreak vulnerability — patched.' },
      { version: '2.0.0', content: 'Major rewrite: added source attribution enforcement.', author: 'Owner E', changedAt: '2026-01-20T15:00:00Z', changeNote: 'Audit finding AUD-2026-001: hallucinated citations detected in prod.' },
    ],
  },
  {
    id: 'PR-003',
    ...
    versions: [
      { version: '1.4.2', content: 'Added protected class non-discrimination clause.', author: 'Owner B', changedAt: '2026-03-28T16:45:00Z', changeNote: 'Legal required explicit fair lending language in fraud prompts post-CFPB guidance.' },
      { version: '1.4.1', content: 'Added device fingerprint step.', author: 'Owner B', changedAt: '2026-02-15T12:00:00Z', changeNote: 'Security team identified missing device check. Added per SEC-2026-008.' },
      { version: '1.4.0', content: 'Restructured to enforce confidence output.', author: 'Owner A', changedAt: '2025-12-10T11:00:00Z', changeNote: 'Evals showed inconsistent output format. Enforced structured output schema.' },
    ],
  },
  {
    id: 'PR-004',
    ...
    approvalDate: null,
    versions: [
      { version: '2.0.0-rc1', content: 'Added GDPR Art.25 data minimization rules.', author: 'Owner H', changedAt: '2026-04-05T09:00:00Z', changeNote: 'DPA audit GAP-005 required strengthened data minimization in support flows. Pending legal sign-off.' },
      { version: '1.3.0', content: 'Previous approved version with basic PII masking.', author: 'Owner A', changedAt: '2025-11-20T14:00:00Z', changeNote: 'Added last-4 masking rule following security review SR-2025-44.' },
    ],
  },
  {
    id: 'PR-005',
    ...
    versions: [
      { version: '1.1.0', content: 'Added regulatory mapping tool and per-session rate limits.', author: 'Owner A', changedAt: '2026-03-10T13:00:00Z', changeNote: 'Extended toolset to support EU AI Act control mapping. Rate limits added after cost incident CI-2026-02.' },
      { version: '1.0.0', content: 'Initial tool call schema with basic risk tools.', author: 'Owner C', changedAt: '2025-10-01T09:00:00Z', changeNote: 'Initial release.' },
    ],
  },
  {
    id: 'PR-006',
    ...
    versions: [
      { version: '4.0.1', content: 'Added PII rejection workflow.', author: 'Owner G', changedAt: '2026-02-20T10:00:00Z', changeNote: 'Bias audit BA-003 found PII leaking into labeled dataset. Added mandatory rejection step.' },
      { version: '4.0.0', content: 'Major rewrite: added confidence scoring and ambiguity handling.', author: 'Owner G', changedAt: '2025-12-05T09:00:00Z', changeNote: 'Inter-annotator agreement was 67% — below 80% threshold. Rewrote guidelines.' },
    ],
  },
  {
    id: 'PR-007',
    ...
    approvalDate: null,
    versions: [
      { version: '0.2.0', content: 'Added data exfiltration test category.', author: 'Owner E', changedAt: '2026-04-08T17:00:00Z', changeNote: 'Expanded adversarial suite based on emerging attack vectors from OWASP LLM Top 10 2025.' },
      { version: '0.1.0', content: 'Initial draft with prompt injection tests only.', author: 'Owner E', changedAt: '2026-04-01T10:00:00Z', changeNote: 'Initial draft for security team review.' },
    ],
  },
  {
    id: 'PR-008',
    ...
    versions: [
      { version: '1.0.3', content: 'Final version before deprecation.', author: 'Owner B', changedAt: '2026-01-15T09:00:00Z', changeNote: 'Deprecated in favor of PR-005. Model upgrade to GPT-4o required new schema.' },
    ],
  },
];
...
export const VENDOR_SLAS: VendorSLA[] = [
  { id: 'SLA-001', vendorId: 'V-001', vendorName: 'Northwind AI', serviceName: 'GPT-4o API', slaType: 'Availability', target: '99.9%', warningThreshold: '99.5%', breachThreshold: '99.0%', measurementWindow: 'Monthly', currentPerformance: '99.7%', status: 'healthy', owner: 'Owner B', escalationPath: 'Owner B → Owner C → Owner E', lastMeasuredAt: '2026-04-01', lastBreachAt: null, linkedTickets: [], notes: 'Measured against Northwind AI status page. EU region had scheduled maintenance window Feb 14.' },
  { id: 'SLA-002', vendorId: 'V-001', vendorName: 'Northwind AI', serviceName: 'GPT-4o API', slaType: 'Support Response', target: 'P1: 1h / P2: 4h / P3: 24h', warningThreshold: 'P1: 2h / P2: 6h', breachThreshold: 'P1: 4h / P2: 12h', measurementWindow: 'Per Incident', currentPerformance: 'P1: avg 1.8h (Mar)', status: 'at_risk', owner: 'Owner B', escalationPath: 'Owner B → Owner C', lastMeasuredAt: '2026-04-01', lastBreachAt: '2026-03-12', linkedTickets: ['TKT-4421'], notes: 'P1 response times trending above target in March. Enterprise CSM engaged for remediation plan.' },
  { id: 'SLA-003', vendorId: 'V-002', vendorName: 'Cirrus ML Platform', serviceName: 'Cirrus ML Inference Endpoints', slaType: 'Availability', target: '99.99%', warningThreshold: '99.95%', breachThreshold: '99.9%', measurementWindow: 'Monthly', currentPerformance: '100%', status: 'healthy', owner: 'Owner A', escalationPath: 'Owner A → Owner D → Owner E', lastMeasuredAt: '2026-04-01', lastBreachAt: null, linkedTickets: [], notes: 'AWS Cirrus ML us-east-1 and eu-west-1 both at 100% for rolling 90-day period.' },
  { id: 'SLA-004', vendorId: 'V-002', vendorName: 'Cirrus ML Platform', serviceName: 'S3 Data Storage', slaType: 'RPO', target: '< 15 min', warningThreshold: '< 30 min', breachThreshold: '> 60 min', measurementWindow: 'Per Incident', currentPerformance: '< 5 min (last DR test)', status: 'healthy', owner: 'Owner A', escalationPath: 'Owner A → Owner D', lastMeasuredAt: '2026-03-15', lastBreachAt: null, linkedTickets: [], notes: 'Quarterly DR test completed 2026-03-15. Cross-region replication verified.' },
  { id: 'SLA-005', vendorId: 'V-004', vendorName: 'VectorPoint', serviceName: 'Vector DB Query API', slaType: 'Availability', target: '99.9%', warningThreshold: '99.5%', breachThreshold: '99.0%', measurementWindow: 'Monthly', currentPerformance: '98.1%', status: 'breached', owner: 'Owner F', escalationPath: 'Owner F → Owner C → Owner E', lastMeasuredAt: '2026-04-01', lastBreachAt: '2026-03-22', linkedTickets: ['TKT-4489', 'TKT-4502'], notes: 'BREACHED: Two outages in March totalling 28h downtime. Vendor RCA provided — database migration failure. Service credits being negotiated.' },
  { id: 'SLA-006', vendorId: 'V-006', vendorName: 'Ironvale Analytics', serviceName: 'Foundry Analytics Platform', slaType: 'Availability', target: '99.9%', warningThreshold: '99.7%', breachThreshold: '99.5%', measurementWindow: 'Monthly', currentPerformance: '99.6%', status: 'at_risk', owner: 'Owner A', escalationPath: 'Owner A → Owner E', lastMeasuredAt: '2026-04-01', lastBreachAt: '2026-02-18', linkedTickets: ['TKT-4380'], notes: 'Performance at warning threshold. Availability impacted by ongoing data residency migration. Enhanced monitoring active.' },
  { id: 'SLA-007', vendorId: 'V-007', vendorName: 'Summit Industrial AI', serviceName: 'Enterprise AI Platform', slaType: 'Incident Notification', target: '< 1h for P1 incidents', warningThreshold: '< 2h', breachThreshold: '> 4h', measurementWindow: 'Per Incident', currentPerformance: 'Avg 6.2h (Q1 2026)', status: 'breached', owner: 'Owner B', escalationPath: 'Owner B → Owner E', lastMeasuredAt: '2026-03-01', lastBreachAt: '2026-03-01', linkedTickets: ['TKT-4350', 'TKT-4398'], notes: 'BREACHED: Repeated failure to notify within SLA window. Vendor on formal breach notice. Data sharing suspended Feb 2026.' },
  { id: 'SLA-008', vendorId: 'V-009', vendorName: 'Labelworks', serviceName: 'Annotation Turnaround', slaType: 'Review Turnaround', target: '< 5 business days per batch', warningThreshold: '5–7 days', breachThreshold: '> 7 days', measurementWindow: 'Per Batch', currentPerformance: 'Avg 4.2 days (Q1)', status: 'healthy', owner: 'Owner F', escalationPath: 'Owner F → Owner D', lastMeasuredAt: '2026-04-01', lastBreachAt: '2025-11-10', linkedTickets: [], notes: 'Performance consistently within target. Last breach Nov 2025 due to annotator shortage. Geo-fencing implementation pending per VA-007 conditions.' },
  { id: 'SLA-009', vendorId: 'V-001', vendorName: 'Northwind AI', serviceName: 'Data Subject Request Support', slaType: 'DSR Support', target: '< 24h acknowledgement / < 30 days fulfillment', warningThreshold: '< 48h / < 25 days', breachThreshold: '> 72h / > 30 days', measurementWindow: 'Per DSR', currentPerformance: 'Avg 18h ack / 22 days fulfillment', status: 'healthy', owner: 'Owner A', escalationPath: 'Owner A → Owner B', lastMeasuredAt: '2026-03-31', lastBreachAt: null, linkedTickets: [], notes: 'GDPR Art. 28 DSR support SLA. 3 DSRs processed in Q1 2026, all within target.' },
  { id: 'SLA-010', vendorId: 'V-008', vendorName: 'KeyGate Identity', serviceName: 'Identity Platform', slaType: 'Availability', target: '99.99%', warningThreshold: '99.95%', breachThreshold: '99.9%', measurementWindow: 'Monthly', currentPerformance: '100%', status: 'healthy', owner: 'Owner A', escalationPath: 'Owner A → Owner E', lastMeasuredAt: '2026-04-01', lastBreachAt: null, linkedTickets: [], notes: 'KeyGate Identity identity platform at 100% availability for 12 consecutive months.' },
];
...
export const TPRM_ISSUES: TPRMIssue[] = [
  { id: 'TI-001', vendorId: 'V-001', vendorName: 'Northwind AI', sourceType: 'Assessment', title: 'Training data lineage insufficient for EU AI Act Art. 10', severity: 'critical', status: 'in_progress', owner: 'Owner F', dueDate: '2026-05-31', remediationPlan: 'Northwind AI to provide data provenance documentation for GPT-4o training corpus. Interim: restrict EU-originating prompts to avoid Art. 10 scope.', linkedAssessmentId: 'VA-002', linkedRiskId: 'RSK-004', linkedIncidentId: null, createdAt: '2026-03-05T10:00:00Z', updatedAt: '2026-04-01T14:30:00Z' },
  { id: 'TI-002', vendorId: 'V-001', vendorName: 'Northwind AI', sourceType: 'Assessment', title: 'Subprocessor change notification lag exceeds 30-day SLA', severity: 'medium', status: 'open', owner: 'Owner B', dueDate: '2026-05-15', remediationPlan: 'Negotiate enhanced subprocessor notification clause in DPA amendment. Target: 14-day advance notice vs current 30-day.', linkedAssessmentId: 'VA-001', linkedRiskId: null, linkedIncidentId: null, createdAt: '2026-02-16T09:00:00Z', updatedAt: '2026-03-20T11:00:00Z' },
  { id: 'TI-003', vendorId: 'V-004', vendorName: 'VectorPoint', sourceType: 'SLA', title: 'SLA breach — 28h downtime in March 2026', severity: 'high', status: 'in_progress', owner: 'Owner F', dueDate: '2026-04-30', remediationPlan: 'Obtain formal RCA from vendor. Negotiate service credits per SLA terms. Evaluate failover to alternative vector DB (Weaviate) as contingency.', linkedAssessmentId: null, linkedRiskId: null, linkedIncidentId: 'INC-001', createdAt: '2026-03-22T18:00:00Z', updatedAt: '2026-04-02T09:00:00Z' },
  { id: 'TI-004', vendorId: 'V-004', vendorName: 'VectorPoint', sourceType: 'Assessment', title: 'DPA not executed — GDPR Art. 28 gap', severity: 'critical', status: 'open', owner: 'Owner A', dueDate: '2026-04-15', remediationPlan: 'Suspend EU data ingestion into VectorPoint. Legal to issue DPA execution request by 2026-04-15. Escalate to CISO if no response within 7 days.', linkedAssessmentId: 'VA-003', linkedRiskId: 'RSK-003', linkedIncidentId: null, createdAt: '2026-03-01T10:00:00Z', updatedAt: '2026-04-01T08:00:00Z' },
  { id: 'TI-005', vendorId: 'V-006', vendorName: 'Ironvale Analytics', sourceType: 'Assessment', title: 'EU data residency not guaranteed — critical GDPR finding', severity: 'critical', status: 'in_progress', owner: 'Owner A', dueDate: '2026-06-30', remediationPlan: 'Ironvale Analytics to configure dedicated EU-West data plane. Interim: no EU-originating regulated data processed via Ironvale Analytics. DPO review required before resumption.', linkedAssessmentId: 'VA-004', linkedRiskId: 'RSK-004', linkedIncidentId: null, createdAt: '2026-03-26T14:00:00Z', updatedAt: '2026-04-01T10:00:00Z' },
  { id: 'TI-006', vendorId: 'V-006', vendorName: 'Ironvale Analytics', sourceType: 'Assessment', title: 'Subprocessor list incomplete — 14 processors undisclosed', severity: 'high', status: 'open', owner: 'Owner A', dueDate: '2026-05-31', remediationPlan: 'Formal written demand for complete subprocessor disclosure. Engage legal to assess contractual remedies if not provided within 30 days.', linkedAssessmentId: 'VA-004', linkedRiskId: null, linkedIncidentId: null, createdAt: '2026-03-26T14:30:00Z', updatedAt: '2026-03-26T14:30:00Z' },
  { id: 'TI-007', vendorId: 'V-007', vendorName: 'Summit Industrial AI', sourceType: 'Audit', title: 'DPA not signed — all data sharing suspended', severity: 'critical', status: 'open', owner: 'Owner A', dueDate: '2026-05-01', remediationPlan: 'Vendor under formal breach notice. Two options: (1) Sign GDPR-compliant DPA within 30 days, (2) initiate contract termination. Legal engaged.', linkedAssessmentId: 'VA-005', linkedRiskId: 'RSK-003', linkedIncidentId: null, createdAt: '2026-02-01T09:00:00Z', updatedAt: '2026-04-01T16:00:00Z' },
  { id: 'TI-008', vendorId: 'V-007', vendorName: 'Summit Industrial AI', sourceType: 'SLA', title: 'Incident notification SLA breached — avg 6.2h vs 1h target', severity: 'high', status: 'open', owner: 'Owner B', dueDate: '2026-04-30', remediationPlan: 'Vendor on formal SLA breach notice. Service credits to be claimed. Likely combined with contract termination proceedings.', linkedAssessmentId: null, linkedRiskId: null, linkedIncidentId: null, createdAt: '2026-03-01T12:00:00Z', updatedAt: '2026-03-15T09:00:00Z' },
  { id: 'TI-009', vendorId: 'V-009', vendorName: 'Labelworks', sourceType: 'Assessment', title: 'APAC annotators accessing PII data without adequate SCCs', severity: 'critical', status: 'in_progress', owner: 'Owner F', dueDate: '2026-04-20', remediationPlan: 'Labelworks implementing geo-fenced annotation queues by 2026-04-20. Interim: PII-tagged data routed to EU-only annotator pool. Weekly progress check with vendor CSM.', linkedAssessmentId: 'VA-007', linkedRiskId: 'RSK-003', linkedIncidentId: null, createdAt: '2026-02-20T10:00:00Z', updatedAt: '2026-04-01T11:00:00Z' },
  { id: 'TI-010', vendorId: 'V-001', vendorName: 'Northwind AI', sourceType: 'External Monitoring', title: 'Northwind AI model outputs leaking rate limit metadata', severity: 'medium', status: 'mitigated', owner: 'Owner C', dueDate: '2026-03-31', remediationPlan: 'Implemented response sanitization layer in API gateway. Northwind AI patched in v1.34 API. Closed with monitoring.', linkedAssessmentId: null, linkedRiskId: null, linkedIncidentId: 'INC-005', createdAt: '2026-02-28T16:00:00Z', updatedAt: '2026-03-20T14:00:00Z' },
  { id: 'TI-011', vendorId: 'V-006', vendorName: 'Ironvale Analytics', sourceType: 'Contract Review', title: 'Data retention clause conflicts with GDPR Art. 5(1)(e)', severity: 'high', status: 'open', owner: 'Owner A', dueDate: '2026-06-30', remediationPlan: 'Legal review initiated. Ironvale Analytics contract amendment required to align retention periods with GDPR. Estimated 90-day negotiation window.', linkedAssessmentId: 'VA-004', linkedRiskId: null, linkedIncidentId: null, createdAt: '2026-03-26T15:00:00Z', updatedAt: '2026-03-26T15:00:00Z' },
];
...
export const VENDOR_DOCUMENTS: VendorDocument[] = [
  { id: 'VD-001', vendorId: 'V-001', vendorName: 'Northwind AI', type: 'DPA', fileName: 'Northwind AI_DPA_v4_2026-02.pdf', status: 'valid', uploadedAt: '2026-02-10', expiresAt: '2027-02-10', owner: 'Owner A' },
  { id: 'VD-002', vendorId: 'V-001', vendorName: 'Northwind AI', type: 'SOC 2', fileName: 'Northwind AI_SOC2_TypeII_2025.pdf', status: 'expiring_soon', uploadedAt: '2025-04-15', expiresAt: '2026-04-30', owner: 'Owner B' },
  { id: 'VD-003', vendorId: 'V-001', vendorName: 'Northwind AI', type: 'AI Transparency', fileName: 'Northwind AI_GPT4o_ModelCard_v2.pdf', status: 'valid', uploadedAt: '2026-01-20', expiresAt: null, owner: 'Owner F' },
  { id: 'VD-004', vendorId: 'V-002', vendorName: 'Cirrus ML Platform', type: 'DPA', fileName: 'AWS_GDPR_DPA_2025.pdf', status: 'valid', uploadedAt: '2025-06-01', expiresAt: '2028-05-31', owner: 'Owner A' },
  { id: 'VD-005', vendorId: 'V-002', vendorName: 'Cirrus ML Platform', type: 'SOC 2', fileName: 'AWS_SOC2_TypeII_2025-H2.pdf', status: 'valid', uploadedAt: '2026-02-01', expiresAt: '2026-09-01', owner: 'Owner A' },
  { id: 'VD-006', vendorId: 'V-002', vendorName: 'Cirrus ML Platform', type: 'ISO Certificate', fileName: 'AWS_ISO27001_Certificate_2025.pdf', status: 'valid', uploadedAt: '2025-11-01', expiresAt: '2026-11-01', owner: 'Owner A' },
  { id: 'VD-007', vendorId: 'V-003', vendorName: 'Meridian Labs', type: 'DPA', fileName: 'Meridian Labs_DPA_2025.pdf', status: 'valid', uploadedAt: '2025-01-15', expiresAt: '2027-01-15', owner: 'Owner A' },
  { id: 'VD-008', vendorId: 'V-003', vendorName: 'Meridian Labs', type: 'SOC 2', fileName: 'Meridian Labs_SOC2_TypeII_2025.pdf', status: 'expiring_soon', uploadedAt: '2025-05-01', expiresAt: '2026-05-15', owner: 'Owner B' },
  { id: 'VD-009', vendorId: 'V-004', vendorName: 'VectorPoint', type: 'DPA', fileName: 'VectorPoint_DPA_Draft_v1.pdf', status: 'missing', uploadedAt: '', expiresAt: null, owner: 'Owner A' },
  { id: 'VD-010', vendorId: 'V-004', vendorName: 'VectorPoint', type: 'SOC 2', fileName: 'VectorPoint_SOC2_TypeII_2025.pdf', status: 'valid', uploadedAt: '2025-12-15', expiresAt: '2026-12-15', owner: 'Owner F' },
  { id: 'VD-011', vendorId: 'V-006', vendorName: 'Ironvale Analytics', type: 'DPA', fileName: 'Ironvale Analytics_DPA_Unsigned.pdf', status: 'missing', uploadedAt: '', expiresAt: null, owner: 'Owner A' },
  { id: 'VD-012', vendorId: 'V-006', vendorName: 'Ironvale Analytics', type: 'Subprocessor List', fileName: 'Ironvale Analytics_Subprocessors_Partial_2026.pdf', status: 'requested', uploadedAt: '2026-01-01', expiresAt: null, owner: 'Owner A' },
  { id: 'VD-013', vendorId: 'V-007', vendorName: 'Summit Industrial AI', type: 'DPA', fileName: 'C3ai_DPA_MISSING.pdf', status: 'missing', uploadedAt: '', expiresAt: null, owner: 'Owner A' },
  { id: 'VD-014', vendorId: 'V-007', vendorName: 'Summit Industrial AI', type: 'SOC 2', fileName: 'C3ai_SOC2_2024.pdf', status: 'expired', uploadedAt: '2024-06-01', expiresAt: '2025-06-01', owner: 'Owner B' },
  { id: 'VD-015', vendorId: 'V-009', vendorName: 'Labelworks', type: 'DPA', fileName: 'ScaleAI_DPA_2025.pdf', status: 'valid', uploadedAt: '2025-01-20', expiresAt: '2027-01-20', owner: 'Owner A' },
  { id: 'VD-016', vendorId: 'V-009', vendorName: 'Labelworks', type: 'Pen Test', fileName: 'ScaleAI_PenTest_2025-Q4.pdf', status: 'expiring_soon', uploadedAt: '2025-10-15', expiresAt: '2026-04-30', owner: 'Owner F' },
  { id: 'VD-017', vendorId: 'V-010', vendorName: 'Lakestone Data', type: 'SOC 2', fileName: 'Lakestone Data_SOC2_TypeII_2025.pdf', status: 'valid', uploadedAt: '2025-09-01', expiresAt: '2026-09-01', owner: 'Owner C' },
  { id: 'VD-018', vendorId: 'V-010', vendorName: 'Lakestone Data', type: 'DPA', fileName: 'Lakestone Data_DPA_2023.pdf', status: 'valid', uploadedAt: '2023-07-01', expiresAt: '2028-06-30', owner: 'Owner A' },
];
