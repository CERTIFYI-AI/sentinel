...
export const USE_CASES = [
  ...
  { id: 'UC-003', title: 'Customer Churn Prediction', goal: 'Predict and prevent customer churn', owner: 'USR-003', riskClass: 'Limited', geography: 'US', industry: 'Financial Services', status: 'Under Review', frameworks: ['NIST AI RMF'], linkedModels: ['MDL-003'], createdDate: '2025-12-01', lastUpdated: '2026-03-01', description: 'Predictive churn scoring for retention campaigns.', stage: 'Staging' },
