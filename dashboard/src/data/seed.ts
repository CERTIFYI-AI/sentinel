...
export const AGENTS: Agent[] = [
  ...
  { id: 'AGT-003', name: 'Northwind AI-API-Connector', type: 'external_api', model: 'GPT-4o', risk: 'high', status: 'confirmed', apiCalls7d: 24500, owner: 'Raj Gupta', department: 'AI/ML', description: 'External API connector for LLM-powered features.', firstSeen: '2025-11-20', lastActive: '2026-03-31', dataAccess: ['customer_queries', 'loan_applications'] },
...
export const RISKS: Risk[] = [
  ...
  { id: 'RSK-010', title: 'Vendor lock-in with Northwind AI', description: 'Over-reliance on Northwind AI for LLM capabilities without viable fallback provider.', category: 'Third-Party', severity: 'low', status: 'accepted', likelihood: 2, impact: 2, score: 4, owner: 'David Kim', linkedModel: 'MDL-004', mitigations: ['Maintain Meridian Labs as backup', 'Abstract LLM interface layer', 'Regular vendor review'], createdDate: '2025-12-01', lastUpdated: '2026-01-15', trending: 'stable' },
...
export const EVIDENCE: Evidence[] = [
  ...
  { id: 'EV-005', title: 'GDPR DPA Agreement — Northwind AI', source: 'Legal', framework: 'GDPR', control: 'Art. 28 — Processor', type: 'Agreement', status: 'expired', lastSync: '2025-12-01', owner: 'James Patel', description: 'Data Processing Agreement with Northwind AI. EXPIRED — renewal required.', fileSize: '456 KB' },
...
export const AUDIT_LOG: AuditEntry[] = [
  ...
  { id: 'AL-005', action: 'Vendor added', entity: 'Summit Industrial AI', entityId: 'V-007', actor: 'David Kim', timestamp: '2026-02-01T09:20:00Z', category: 'vendor', details: 'New vendor registered. Flagged as HIGH RISK — DPA not signed.' },
...
export const GAPS: Gap[] = [
  ...
  { id: 'GAP-005', title: 'Vendor AI processing agreements need DPA updates', framework: 'GDPR', controlRef: 'Art. 28', severity: 'critical', progress: 10, dueDate: '2026-04-15', owner: 'James Patel', description: 'DPA with Northwind AI expired. Other vendor DPAs need AI-specific clauses.' },
...
export const VENDOR_SLAS: VendorSLA[] = [
  { id: 'SLA-001', vendorId: 'V-001', vendorName: 'Northwind AI', serviceName: 'GPT-4o API', slaType: 'Availability', target: '99.9%', warningThreshold: '99.5%', breachThreshold: '99.0%', measurementWindow: 'Monthly', currentPerformance: '99.7%', status: 'healthy', owner: 'David Kim', escalationPath: 'David Kim → Raj Gupta → Sarah Chen', lastMeasuredAt: '2026-04-01', lastBreachAt: null, linkedTickets: [], notes: 'Measured against Northwind AI status page. EU region had scheduled maintenance window Feb 14.' },
  { id: 'SLA-002', vendorId: 'V-001', vendorName: 'Northwind AI', serviceName: 'GPT-4o API', slaType: 'Support Response', target: 'P1: 1h / P2: 4h / P3: 24h', warningThreshold: 'P1: 2h / P2: 6h', breachThreshold: 'P1: 4h / P2: 12h', measurementWindow: 'Per Incident', currentPerformance: 'P1: avg 1.8h (Mar)', status: 'at_risk', owner: 'David Kim', escalationPath: 'David Kim → Raj Gupta', lastMeasuredAt: '2026-04-01', lastBreachAt: '2026-03-12', linkedTickets: ['TKT-4421'], notes: 'P1 response times trending above target in March. Enterprise CSM engaged for remediation plan.' },
  { id: 'SLA-003', vendorId: 'V-002', vendorName: 'Cirrus ML Platform', serviceName: 'Cirrus ML Inference Endpoints', slaType: 'Availability', target: '99.99%', warningThreshold: '99.95%', breachThreshold: '99.9%', measurementWindow: 'Monthly', currentPerformance: '100%', status: 'healthy', owner: 'James Patel', escalationPath: 'James Patel → Maria Santos → Sarah Chen', lastMeasuredAt: '2026-04-01', lastBreachAt: null, linkedTickets: [], notes: 'AWS Cirrus ML us-east-1 and eu-west-1 both at 100% for rolling 90-day period.' },
  { id: 'SLA-004', vendorId: 'V-002', vendorName: 'Cirrus ML Platform', serviceName: 'S3 Data Storage', slaType: 'RPO', target: '< 15 min', warningThreshold: '< 30 min', breachThreshold: '> 60 min', measurementWindow: 'Per Incident', currentPerformance: '< 5 min (last DR test)', status: 'healthy', owner: 'James Patel', escalationPath: 'James Patel → Maria Santos', lastMeasuredAt: '2026-03-15', lastBreachAt: null, linkedTickets: [], notes: 'Quarterly DR test completed 2026-03-15. Cross-region replication verified.' },
  { id: 'SLA-005', vendorId: 'V-004', vendorName: 'VectorPoint', serviceName: 'Vector DB Query API', slaType: 'Availability', target: '99.9%', warningThreshold: '99.5%', breachThreshold: '99.0%', measurementWindow: 'Monthly', currentPerformance: '98.1%', status: 'breached', owner: 'Emma Wilson', escalationPath: 'Emma Wilson → Raj Gupta → Sarah Chen', lastMeasuredAt: '2026-04-01', lastBreachAt: '2026-03-22', linkedTickets: ['TKT-4489', 'TKT-4502'], notes: 'BREACHED: Two outages in March totalling 28h downtime. Vendor RCA provided — database migration failure. Service credits being negotiated.' },
  ...
  { id: 'SLA-008', vendorId: 'V-009', vendorName: 'Labelworks', serviceName: 'Annotation Turnaround', slaType: 'Review Turnaround', target: '< 5 business days per batch', warningThreshold: '5–7 days', breachThreshold: '> 7 days', measurementWindow: 'Per Batch', currentPerformance: 'Avg 4.2 days (Q1)', status: 'healthy', owner: 'Emma Wilson', escalationPath: 'Emma Wilson → Maria Santos', lastMeasuredAt: '2026-04-01', lastBreachAt: '2025-11-10', linkedTickets: [], notes: 'Performance consistently within target. Last breach Nov 2025 due to annotator shortage. Geo-fencing implementation pending per VA-007 conditions.' },
...
export const TPRM_ISSUES: TPRMIssue[] = [
  { id: 'TI-001', vendorId: 'V-001', vendorName: 'Northwind AI', sourceType: 'Assessment', title: 'Training data lineage insufficient for EU AI Act Art. 10', severity: 'critical', status: 'in_progress', owner: 'Emma Wilson', dueDate: '2026-05-31', remediationPlan: 'Northwind AI to provide data provenance documentation for GPT-4o training corpus. Interim: restrict EU-originating prompts to avoid Art. 10 scope.', linkedAssessmentId: 'VA-002', linkedRiskId: 'RSK-004', linkedIncidentId: null, createdAt: '2026-03-05T10:00:00Z', updatedAt: '2026-04-01T14:30:00Z' },
  { id: 'TI-002', vendorId: 'V-001', vendorName: 'Northwind AI', sourceType: 'Assessment', title: 'Subprocessor change notification lag exceeds 30-day SLA', severity: 'medium', status: 'open', owner: 'David Kim', dueDate: '2026-05-15', remediationPlan: 'Negotiate enhanced subprocessor notification clause in DPA amendment. Target: 14-day advance notice vs current 30-day.', linkedAssessmentId: 'VA-001', linkedRiskId: null, linkedIncidentId: null, createdAt: '2026-02-16T09:00:00Z', updatedAt: '2026-03-20T11:00:00Z' },
  ...
  { id: 'TI-009', vendorId: 'V-009', vendorName: 'Labelworks', sourceType: 'Assessment', title: 'APAC annotators accessing PII data without adequate SCCs', severity: 'critical', status: 'in_progress', owner: 'Emma Wilson', dueDate: '2026-04-20', remediationPlan: 'Labelworks implementing geo-fenced annotation queues by 2026-04-20. Interim: PII-tagged data routed to EU-only annotator pool. Weekly progress check with vendor CSM.', linkedAssessmentId: 'VA-007', linkedRiskId: 'RSK-003', linkedIncidentId: null, createdAt: '2026-02-20T10:00:00Z', updatedAt: '2026-04-01T11:00:00Z' },
  { id: 'TI-010', vendorId: 'V-001', vendorName: 'Northwind AI', sourceType: 'External Monitoring', title: 'Northwind AI model outputs leaking rate limit metadata', severity: 'medium', status: 'mitigated', owner: 'Raj Gupta', dueDate: '2026-03-31', remediationPlan: 'Implemented response sanitization layer in API gateway. Northwind AI patched in v1.34 API. Closed with monitoring.', linkedAssessmentId: null, linkedRiskId: null, linkedIncidentId: 'INC-005', createdAt: '2026-02-28T16:00:00Z', updatedAt: '2026-03-20T14:00:00Z' },
...
export const VENDOR_DOCUMENTS: VendorDocument[] = [
  { id: 'VD-001', vendorId: 'V-001', vendorName: 'Northwind AI', type: 'DPA', fileName: 'Northwind AI_DPA_v4_2026-02.pdf', status: 'valid', uploadedAt: '2026-02-10', expiresAt: '2027-02-10', owner: 'James Patel' },
  { id: 'VD-002', vendorId: 'V-001', vendorName: 'Northwind AI', type: 'SOC 2', fileName: 'Northwind AI_SOC2_TypeII_2025.pdf', status: 'expiring_soon', uploadedAt: '2025-04-15', expiresAt: '2026-04-30', owner: 'David Kim' },
  { id: 'VD-003', vendorId: 'V-001', vendorName: 'Northwind AI', type: 'AI Transparency', fileName: 'Northwind AI_GPT4o_ModelCard_v2.pdf', status: 'valid', uploadedAt: '2026-01-20', expiresAt: null, owner: 'Emma Wilson' },
  { id: 'VD-004', vendorId: 'V-002', vendorName: 'Cirrus ML Platform', type: 'DPA', fileName: 'AWS_GDPR_DPA_2025.pdf', status: 'valid', uploadedAt: '2025-06-01', expiresAt: '2028-05-31', owner: 'James Patel' },
  { id: 'VD-005', vendorId: 'V-002', vendorName: 'Cirrus ML Platform', type: 'SOC 2', fileName: 'AWS_SOC2_TypeII_2025-H2.pdf', status: 'valid', uploadedAt: '2026-02-01', expiresAt: '2026-09-01', owner: 'James Patel' },
  { id: 'VD-006', vendorId: 'V-002', vendorName: 'Cirrus ML Platform', type: 'ISO Certificate', fileName: 'AWS_ISO27001_Certificate_2025.pdf', status: 'valid', uploadedAt: '2025-11-01', expiresAt: '2026-11-01', owner: 'James Patel' },
  { id: 'VD-007', vendorId: 'V-003', vendorName: 'Meridian Labs', type: 'DPA', fileName: 'Meridian Labs_DPA_2025.pdf', status: 'valid', uploadedAt: '2025-01-15', expiresAt: '2027-01-15', owner: 'James Patel' },
  { id: 'VD-008', vendorId: 'V-003', vendorName: 'Meridian Labs', type: 'SOC 2', fileName: 'Meridian Labs_SOC2_TypeII_2025.pdf', status: 'expiring_soon', uploadedAt: '2025-05-01', expiresAt: '2026-05-15', owner: 'David Kim' },
  { id: 'VD-009', vendorId: 'V-004', vendorName: 'VectorPoint', type: 'DPA', fileName: 'VectorPoint_DPA_Draft_v1.pdf', status: 'missing', uploadedAt: '', expiresAt: null, owner: 'James Patel' },
  { id: 'VD-010', vendorId: 'V-004', vendorName: 'VectorPoint', type: 'SOC 2', fileName: 'VectorPoint_SOC2_TypeII_2025.pdf', status: 'valid', uploadedAt: '2025-12-15', expiresAt: '2026-12-15', owner: 'Emma Wilson' },
  { id: 'VD-011', vendorId: 'V-006', vendorName: 'Ironvale Analytics', type: 'DPA', fileName: 'Ironvale Analytics_DPA_Unsigned.pdf', status: 'missing', uploadedAt: '', expiresAt: null, owner: 'James Patel' },
  { id: 'VD-012', vendorId: 'V-006', vendorName: 'Ironvale Analytics', type: 'Subprocessor List', fileName: 'Ironvale Analytics_Subprocessors_Partial_2026.pdf', status: 'requested', uploadedAt: '2026-01-01', expiresAt: null, owner: 'James Patel' },
  { id: 'VD-013', vendorId: 'V-007', vendorName: 'Summit Industrial AI', type: 'DPA', fileName: 'C3ai_DPA_MISSING.pdf', status: 'missing', uploadedAt: '', expiresAt: null, owner: 'James Patel' },
  { id: 'VD-014', vendorId: 'V-007', vendorName: 'Summit Industrial AI', type: 'SOC 2', fileName: 'C3ai_SOC2_2024.pdf', status: 'expired', uploadedAt: '2024-06-01', expiresAt: '2025-06-01', owner: 'David Kim' },
  { id: 'VD-015', vendorId: 'V-009', vendorName: 'Labelworks', type: 'DPA', fileName: 'ScaleAI_DPA_2025.pdf', status: 'valid', uploadedAt: '2025-01-20', expiresAt: '2027-01-20', owner: 'James Patel' },
  { id: 'VD-016', vendorId: 'V-009', vendorName: 'Labelworks', type: 'Pen Test', fileName: 'ScaleAI_PenTest_2025-Q4.pdf', status: 'expiring_soon', uploadedAt: '2025-10-15', expiresAt: '2026-04-30', owner: 'Emma Wilson' },
  { id: 'VD-017', vendorId: 'V-010', vendorName: 'Lakestone Data', type: 'SOC 2', fileName: 'Lakestone Data_SOC2_TypeII_2025.pdf', status: 'valid', uploadedAt: '2025-09-01', expiresAt: '2026-09-01', owner: 'Raj Gupta' },
  { id: 'VD-018', vendorId: 'V-010', vendorName: 'Lakestone Data', type: 'DPA', fileName: 'Lakestone Data_DPA_2023.pdf', status: 'valid', uploadedAt: '2023-07-01', expiresAt: '2028-06-30', owner: 'James Patel' },
];
