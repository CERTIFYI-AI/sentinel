...
export const RISKS: Risk[] = [
  ...
  { id: 'RSK-007', title: 'EU AI Act Article 11 documentation gap', description: 'Technical documentation requirements not met for high-risk AI systems.', category: 'Governance', severity: 'high', status: 'open', likelihood: 4, impact: 3, score: 12, owner: 'Emma Wilson', linkedModel: '', mitigations: ['Document all high-risk models', 'Implement model cards', 'Automate documentation generation'], createdDate: '2026-01-10', lastUpdated: '2026-03-12', trending: 'stable' },
