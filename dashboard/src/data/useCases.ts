...
export const seedActivityLogs: Record<string, ActivityEntry[]> = {
  'UC-001': [
    { id: 'ACT-001', timestamp: '2025-03-28T10:30:00Z', actor: 'Sarah Chen', action: 'Updated controls progress to 74%' },
    { id: 'ACT-002', timestamp: '2025-03-25T14:15:00Z', actor: 'James Patel', action: 'Added risk RISK-002: Model drift', field: 'risks' },
    { id: 'ACT-003', timestamp: '2025-03-20T09:00:00Z', actor: 'System', action: 'Approval granted by executive review' },
    { id: 'ACT-004', timestamp: '2025-03-15T16:45:00Z', actor: 'Sarah Chen', action: 'Submitted for approval', field: 'approvalStatus', oldValue: 'None', newValue: 'Pending' },
    { id: 'ACT-005', timestamp: '2024-06-01T08:00:00Z', actor: 'Sarah Chen', action: 'Created use case UC-001' },
  ],
  'UC-003': [
    { id: 'ACT-010', timestamp: '2025-03-20T11:00:00Z', actor: 'Maria Santos', action: 'Submitted for approval', field: 'approvalStatus', oldValue: 'None', newValue: 'Pending' },
    { id: 'ACT-011', timestamp: '2025-03-18T09:30:00Z', actor: 'Maria Santos', action: 'Changed status', field: 'status', oldValue: 'In Progress', newValue: 'Under Review' },
  ],
  'UC-005': [
    { id: 'ACT-020', timestamp: '2025-02-15T10:00:00Z', actor: 'Review Board', action: 'Rejected: Bias concerns must be addressed before proceeding', field: 'approvalStatus', oldValue: 'Pending', newValue: 'Rejected' },
    { id: 'ACT-021', timestamp: '2025-02-01T14:00:00Z', actor: 'David Kim', action: 'Submitted for approval' },
  ],
};
