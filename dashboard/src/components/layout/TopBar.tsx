    ...
    <>
      <header className="h-12 border-b border-border bg-background flex items-center px-4 gap-3 shrink-0">
        ...
        <button
          ...
          className="hidden md:flex items-center gap-2 flex-1 max-w-md mx-auto bg-muted/50 rounded-md px-3 py-1.5 text-sm text-muted-foreground hover:bg-muted transition-colors"
        >
