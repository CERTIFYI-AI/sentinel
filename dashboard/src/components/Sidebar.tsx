...
import {
  CaretDown, Gear, List, MagnifyingGlass, Monitor, Moon,
  SidebarSimple as SidebarCollapseIcon, SignOut, Sun, X
...
// Navigation structure, types and helpers live in `data/navigation.ts` — the
// single source of truth shared with the User guide, so the menu and the
// documentation of the menu can never drift apart.
import { NAV, type NavSection, type NavItem } from '../data/navigation'
