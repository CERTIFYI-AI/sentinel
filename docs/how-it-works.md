...
GPU acceleration reduces the Verify stage from 150–400ms to 15–40ms. See [Scaling Guide](ops/scaling-guide.md).

## Next Steps

- [Quickstart](guides/quickstart.md) — Send your first verified request in 10 minutes.
- [Architecture](architecture.md) — 30-minute deep dive into system design.
- [Trust Score Reference](reference/trust-score.md) — Understand and tune the scoring formula.
- [Configuration](configuration.md) — Every configuration option explained.
