...
| Art. 9 | **GenAI-specific risk catalogue** — NIST AI 600-1 risk taxonomy mapped per model | [GenAI Risk Profiles](../modules/genai-risk-profiles.md) — `genai_risk_profiles`, 12 risk categories, severity, guardrail coverage, mitigation workflow | Implemented |
