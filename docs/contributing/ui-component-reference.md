...
> never hardcode a hex value in JSX. See [ADR-0007](../architecture/adr/0007-outfit-only-typography.md)
> for typography.
...
(see [troubleshooting → Dashboard](../getting-started/troubleshooting.md)):
