...
- [Architecture](../architecture/overview.md) -- understand the five-layer pipeline
...
- [Deployment Guide](../operations/deployment.md) -- production deployment on AWS, GCP, or bare metal
