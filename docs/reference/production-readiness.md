...
3. **12 modules still sit on demo doc-tables (TD-001), down from ~19.** The last
   ...
   (`20260825000001`), which also surfaced and fixed the invisible MRC id defect
