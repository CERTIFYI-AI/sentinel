...
//
// WS2 — Regulatory Horizon (scaffolded page).
// Category: Governance
//
...
export default function RegulatoryHorizon() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Upcoming regulations mapped to products and controls."
      icon={Compass}
      breadcrumb={[{ label: "Governance" }, { label: "Regulatory Horizon" }]}
    ...
    >
      <section aria-label="Regulatory Horizon records">
