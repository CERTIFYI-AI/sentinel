...
//
// WS2 — Board Reports (scaffolded page).
// Category: Governance
//
...
export default function BoardReports() {
  ...
  return (
    <ModuleScaffold
      title="Board Reports"
      subtitle="Quarterly governance reports for the board and audit committee."
      icon={Buildings}
      breadcrumb={[{ label: "Governance" }, { label: "Board Reports" }]}
    ...
    >
      <section aria-label="Board Reports records">
