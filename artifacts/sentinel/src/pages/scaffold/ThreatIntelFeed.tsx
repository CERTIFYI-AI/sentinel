...
//
// WS2 — Threat Intel Feed (scaffolded page).
// Category: Threats
//
...
export default function ThreatIntelFeed() {
  ...
  return (
    <ModuleScaffold
      ...
      subtitle="Curated indicators from MISP, ISAC, and OSINT sources."
      icon={Lightning}
      breadcrumb={[{ label: "Threats" }, { label: "Threat Intel Feed" }]}
    ...
    >
      <section aria-label="Threat Intel Feed records">
