...
export const policiesApi = {
  ...
  create: async (data: any) => {
    ...
    await logAction({ module: MODULE, entityType: 'policies', entityId: result?.id, entityName: result?.name || result?.title, action: 'create', newValues: result });
    return result;
  },
  ...
  update: async (id: string, data: any) => {
    ...
    await logAction({ module: MODULE, entityType: 'policies', entityId: id, action: 'update', newValues: data });
    return result;
  },
  ...
  delete: async (id: string, name?: string) => {
    ...
    await logAction({ module: MODULE, entityType: 'policies', entityId: id, entityName: name, action: 'delete' });
  },
};
