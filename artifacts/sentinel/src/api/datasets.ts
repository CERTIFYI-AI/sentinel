...
export const datasetsApi = {
  ...
  create: async (data: any) => {
    ...
    await logAction({ module: MODULE, entityType: 'datasets', entityId: result?.id, entityName: result?.name || result?.title, action: 'create', newValues: result });
    return result;
  },
  ...
  update: async (id: string, data: any) => {
    ...
    await logAction({ module: MODULE, entityType: 'datasets', entityId: id, action: 'update', newValues: data });
    return result;
  },
  ...
  delete: async (id: string, name?: string) => {
    ...
    await logAction({ module: MODULE, entityType: 'datasets', entityId: id, entityName: name, action: 'delete' });
  },
};
