...
export const tasksApi = {
  ...
  create: async (data: any) => {
    ...
    await logAction({ module: MODULE, entityType: 'tasks', entityId: result?.id, entityName: result?.name || result?.title, action: 'create', newValues: result });
    return result;
  },
  ...
  update: async (id: string, data: any) => {
    ...
    await logAction({ module: MODULE, entityType: 'tasks', entityId: id, action: 'update', newValues: data });
    return result;
  },
  ...
  delete: async (id: string, name?: string) => {
    ...
    await logAction({ module: MODULE, entityType: 'tasks', entityId: id, entityName: name, action: 'delete' });
  },
};
