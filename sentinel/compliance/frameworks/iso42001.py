...
class ISO42001Framework(BaseFramework):
    ...
    def _a81(self,c,e,r,cfg):
        ...
        return self._r(c,ControlStatus.FAIL,0.0,"injection_blocked,semantic_drift_sigma,circuit_breaker_state",{"injection":inj_blocked,"drift":drift,"cb":cb},f"AI incident detected: {", ".join(details)}. Logged for incident management review.",f"Review audit entry. Investigate: {", ".join(details)}.")
