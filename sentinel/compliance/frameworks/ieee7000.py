...
class IEEE7000Framework(BaseFramework):
    metadata=FrameworkMetadata('ieee7000','IEEE 7000-2021','Std 7000-2021',FrameworkStatus.TECH_STANDARD,'International (IEEE)','Available now','https://standards.ieee.org/ieee/7000/6781/','3 of 7 processes evaluated. IEEE 7000 is primarily a design-time standard. Sentinel provides runtime evidence for 3 of 12 process areas.')
    controls=[
    ...
    def _evaluate_control(self,ctrl,entry,result,config):
        return {'p75':self._p75,'p83':self._p83,'p92':self._p92}[ctrl.control_id](ctrl,entry,result,config)
