...
class AwsSecretsManagerAdapter:
    ...
    async def fetch_all(self) -> list[IntegrationFinding]:
        ...
        for result in results:
            if isinstance(result, BaseException):
                logger.warning("aws_secrets_manager check failed: %s", result)
                continue
    ...
    async def _check_secrets_inventory(self) -> list[IntegrationFinding]:
        try:
            ...
            logger.warning("aws_secrets_manager.secrets.inventory: %s", exc)
    ...
    async def _check_secrets_rotation(self) -> list[IntegrationFinding]:
        try:
            ...
            logger.warning("aws_secrets_manager.secrets.rotation: %s", exc)
            return [IntegrationFinding(
    ...
    async def _check_secrets_last_accessed(self) -> list[IntegrationFinding]:
        try:
            ...
            logger.warning("aws_secrets_manager.secrets.last_accessed: %s", exc)
            return [IntegrationFinding(
